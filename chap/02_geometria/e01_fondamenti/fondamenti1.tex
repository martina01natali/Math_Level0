...
% La stessa costruzione realizzata con la geometria interattiva.
% 
% \lstinputlisting{\folder src/11triequi.py}
...
%   Costruzione della perpendicolare a una retta, passante per un punto C esterno 
% ad essa:
%   \begin{enumerate} [nosep]
%     \item 
