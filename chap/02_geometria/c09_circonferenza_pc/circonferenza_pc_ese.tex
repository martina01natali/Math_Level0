...
% \quad r = \sqrt{20}\)]
% 
% %   \item  \(A \left (-8; \quad -6 \right ); \quad B \left (-8; \quad 0 \right ); 
% % \quad C \left (-2; \quad -6 \right )\)
% % 
% %    \hfill [\(x^2 + y^2 +10x +6y +16 = 0; \quad C \left (-5; \quad -3 \right ); 
% % \quad r = \sqrt{18}\)]
% % 
% %   \item  \(A \left (-5; \quad -4 \right ); \quad B \left (-5; \quad -2 \right ); 
% % \quad C \left (-5; \quad -2 \right )\)
% % 
% %    \hfill [\(x^2 + y^2 +12x +6y +43 = 0; \quad C \left (-6; \quad -3 \right ); 
% % \quad r = \sqrt{2}\)]
%  \end{enumeratea}
% \end{esercizio}
...
%  \begin{enumeratea}
%   \item  \(c:~x^2 + y^2 +8x +8y +23 = 0;~r:~y = -2 x -3\)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 +4x +12y +39 = 0;~r:~y = \frac{8}{5} x -\frac{1}{5}\)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 -6x +8y +21 = 0;~r:~y = -4 x -15\)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 +8x -8y +31 = 0;~r:~y = \frac{9}{8} x -\frac{1}{2}\)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 +4x -8y +11 = 0;~r:~y = \frac{4}{3} x +\frac{8}{3}\)
%    \hfill [\(\left (-\frac{29}{225};~\frac{1684}{675} \right );~\left 
% (\frac{1}{9};~\frac{76}{27} \right )\)]
%   \item  \(c:~x^2 + y^2 -8y +7 = 0;~r:~y = \frac{3}{5} x \)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 +10x -6y +30 = 0;~r:~x = 1\)
%    \hfill [\(\emptyset\)]
%   \item  \(c:~x^2 + y^2 +6x +4y +9 = 0;~r:~y = -4\)
...
% 
% %   \item  \(Centro=\left (3; \quad 2 \right ); \quad r = \sqrt{10}; \quad 
% % retta: y = \frac{1}{2} x -2\)
% % 
% %    \hfill [\(x^2 + y^2 -6x -4y +3 = 0; \quad A = \left (2; \quad -1 \right ); 
% % \quad B = \left (6; \quad 1 \right )\)]
% % 
% %   \item  \(Centro=\left (-2; \quad -6 \right ); \quad r = \sqrt{25}; \quad 
% % retta: y = -\frac{3}{4} x -\frac{15}{2}\)
% % 
% %    \hfill [\(x^2 + y^2 +4x +12y +15 = 0; \quad A = \left (2; \quad -9 \right ); 
...
\begin{esercizio}\label{ese:}
 ...
 \begin{enumeratea}
  \item  \(c0:~x^2 + y^2 -12x +6y -253 = 0;~c1:~x^2 + y^2 -18x -355 = 0\)\\
.
   \hfill [\(ar:~y = - x -17;~A \left (-11;~-6 \right );~B \left (-20;~3 
\right )\)]
  \item  \(c0:~x^2 + y^2 +2x +12y -109 = 0;~c1:~x^2 + y^2 +8x -\frac{6}{5}y 
-7 = 0\)\\
.
   \hfill [\(ar:~y = \frac{5}{11} x +\frac{85}{11};~A \left (-6;~5 \right )\)]
  \item  \(c0:~x^2 + y^2 +10x -10y +24 = 0;~c1:~x^2 + y^2 -8x -10y +28 = 0\)\\
.
   \hfill [\(ar:~x = \frac{2}{9};~\emptyset\)]
%   \item  \(c0:~x^2 + y^2 -18x +2y +41 = 0;~c1:~x^2 + y^2 -14x +12y -5 = 
% 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{2}{5} x +\frac{23}{5};~A \left (4;~3 \right 
% );~B % \left (-\frac{45}{29};~\frac{446}{29} \right )\)]
  \item  \(c0:~x^2 + y^2 +18x +10y -54 = 0;~c1:~x^2 + y^2 +14x +12y -40 = 
0\)\\
.
   \hfill [\(ar:~y = 2 x -7;~A \left (3;~-1 \right );~B \left (-17;~-5 \right 
)\)]
  \item  \(c0:~x^2 + y^2 -6x +10y +17 = 0;~c1:~x^2 + y^2 +4x +50y +17 = 0\)\\
.
   \hfill [\(ar:~y = -\frac{1}{4} x ;~A \left (4;~-1 \right )\)]
  \item  \(c0:~x^2 + y^2 +6y +4 = 0;~c1:~x^2 + y^2 +2x -4y  = 0\)\\
.
   \hfill [\(ar:~y = \frac{1}{5} x -\frac{2}{5};~\emptyset\)]
  \item  \(c0:~x^2 + y^2 -6x +8y -75 = 0;~c1:~x^2 + y^2 -8x +16y +39 = 0\)\\
.
   \hfill [\(ar:~y = \frac{1}{4} x -\frac{57}{4};~A \left (9;~-12 \right );~B 
\left (-\frac{236}{17};~\frac{25}{17} \right )\)]
  \item  \(c0:~x^2 + y^2 -10x -6y +24 = 0;~c1:~x^2 + y^2 +8x -10y +23 = 0\)\\
.
   \hfill [\(ar:~y = \frac{9}{2} x -\frac{1}{4};~\emptyset\)]
  \item  \(c0:~x^2 + y^2 -10x -16y -144 = 0;~c1:~x^2 + y^2 +10x +24y +116 = 
0\)\\
.
   \hfill [\(ar:~y = -\frac{1}{2} x -\frac{13}{2};~A \left (-3;~-5 \right 
);~B \left (-\frac{31}{5};~-\frac{3}{5} \right )\)]
  \item  \(c0:~x^2 + y^2 +6x +2y -6 = 0;~c1:~x^2 + y^2 +8x +2y -8 = 0\)\\
.
   \hfill [\(ar:~x = 1;~A \left (1;~-1 \right )\)]
%   \item  \(c0:~x^2 + y^2 +6x +14y -27 = 0;~c1:~x^2 + y^2 +4x -22y -195 = 
% 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{1}{18} x -\frac{14}{3};~A \left (6;~-5 \right 
% );~B % \left (-\frac{261}{65};~-\frac{762}{65} \right )\)]
%   \item  \(c0:~x^2 + y^2 -2x +8y -96 = 0;~c1:~x^2 + y^2 -12x +22y -212 = 
% 0\)\\
% .
%    \hfill [\(ar:~y = \frac{5}{7} x +\frac{58}{7};~A \left (-6;~4 \right 
% );~B 
% \left (\frac{193}{37};~-\frac{159}{37} \right )\)]
%   \item  \(c0:~x^2 + y^2 -12x -12y -13 = 0;~c1:~x^2 + y^2 +14y -81 = 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{6}{13} x +\frac{34}{13};~A \left (-3;~4 \right 
% );~B \left (-\frac{88}{41};~\frac{423}{41} \right )\)]
%   \item  \(c0:~x^2 + y^2 +8x +12y +15 = 0;~c1:~x^2 + y^2 -4x +16y +59 = 
% 0\)\\
% .
...
%   \item  \(c0:~x^2 + y^2 +18x -14y -328 = 0;~c1:~x^2 + y^2 -16x +28 = 0\)\\
% .
...
% %  Calcola l'asse radicale e le intersezioni delle due circonferenze.
% %  \begin{enumeratea}
%   \item  \(c0:~x^2 + y^2 +10x +2y -27 = 0;~c1:~x^2 + y^2 +4x +\frac{26}{7}y 
% -\frac{69}{7} = 0\)\\
% .
%    \hfill [\(ar:~y = \frac{7}{2} x -10;~A \left (2;~-3 \right )\)]
%   \item  \(c0:~x^2 + y^2 +2x -8y +4 = 0;~c1:~x^2 + y^2 +12x -23y +9 = 0\)\\
% .
%    \hfill [\(ar:~y = \frac{2}{3} x +\frac{1}{3};~A \left (1;~1 \right )\)]
%   \item  \(c0:~x^2 + y^2 -2x -8y +7 = 0;~c1:~x^2 + y^2 +12x -\frac{10}{3}y 
% +21 
% = 0\)\\
% .
%    \hfill [\(ar:~y = -3 x -3;~A \left (-2;~3 \right )\)]
%   \item  \(c0:~x^2 + y^2 +2x +4y -5 = 0;~c1:~x^2 + y^2 -6x -20y +19 = 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{1}{3} x +1;~A \left (0;~1 \right )\)]
%   \item  \(c0:~x^2 + y^2 -4x +10y -56 = 0;~c1:~x^2 + y^2 +2x +37y -188 = 
% 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{2}{9} x +\frac{44}{9};~A \left (4;~4 \right )\)]
%   \item  \(c0:~x^2 + y^2 -4x +4y -37 = 0;~c1:~x^2 + y^2 +6y -11 = 0\)\\
% .
...
%  Calcola l'asse radicale e le intersezioni delle due circonferenze.
%  \begin{enumeratea}
%   \item  \(c0:~x^2 + y^2 -10x +8y +15 = 0;~c1:~x^2 + y^2 -4x -4y -12 = 0\)\\
% .
%    \hfill [\(ar:~y = \frac{1}{2} x -\frac{9}{4};~A (10, 33, 924)\)]
%   \item  \(c0:~x^2 + y^2 -10y - = 0;~c1:~x^2 + y^2 +2x +2y -11 = 0\)\\
% .
%    \hfill [\(ar:~y = -\frac{1}{6} x +\frac{5}{6};~A (37, -25, 12132)\)]
%   \item  \(c0:~x^2 + y^2 -8x - = 0;~c1:~x^2 + y^2 -8x -8y +27 = 0\)\\
% .
%    \hfill [\(ar:~y = \frac{7}{2};~A (2, 8, 19)\)]
%   \item  \(c0:~x^2 + y^2 -10x +10y +25 = 0;~c1:~x^2 + y^2 -8x -9 = 0\)\\
% .
%    \hfill [\(ar:~y = \frac{1}{5} x -\frac{17}{5};~A (26, 117, 12025)\)]
%   \item  \(c0:~x^2 + y^2 -2y -9 = 0;~c1:~x^2 + y^2 -8x -18 = 0\)\\
% .
%    \hfill [\(ar:~y = 4 x +\frac{9}{2};~A (34, -28, 631)\)]
%   \item  \(c0:~x^2 + y^2 -32 = 0;~c1:~x^2 + y^2 -8x -4y -20 = 0\)\\
% .
%    \hfill [\(ar:~y = -2 x +3;~A (5, 6, 151)\)]
%   \item  \(c0:~x^2 + y^2 -2x -8y -44 = 0;~c1:~x^2 + y^2 -8x -2y -9 = 0\)\\
% .
