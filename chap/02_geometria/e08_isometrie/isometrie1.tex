...
\begin{center}
 \noindent\begin{minipage}{0.4\textwidth}
    \centering\input{\folder lbr/fig001_es.pgf}
	\caption{Esempio~\ref{es:8.1}}\label{fig:es8.1a}
 \end{minipage}
 %\hspace{0.05\textwidth}
 \noindent\begin{minipage}{0.4\textwidth}
    \centering\input{\folder lbr/fig002_es.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
    \centering\input{\folder lbr/fig003_es.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig006_retta_unita.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig007_retta_fissa.pgf}
\end{minipage}
...
\begin{procedura}
	Costruzione con riga e compasso del simmetrico di un punto P rispetto ad un centro K:
	\begin{enumerate} [nosep]
		...
		\item 
		Denomina P' il punto, diverso da P, di intersezione fra la semiretta e la circonferenza.  
		\item 
...
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig008_simm_centr.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig009_simm_centr_isomet.pgf}
\end{minipage}
...
\centering\input{\folder lbr/fig010_simm_centr_rette_parall.pgf}
\end{minipage}\vspace{8pt}
...
\begin{figure*}[!htb]
    \centering\input{\folder lbr/fig011_es.pgf}
\end{figure*}
...
\begin{figure*}[!htb]
    \centering\input{\folder lbr/fig012_es.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{\folder lbr/fig013_simm_ass.pgf}
\end{wrapfigure}

\begin{procedura}
	Costruzione con riga e compasso del simmetrico di un punto P rispetto ad un asse k:
	\begin{enumerate} [nosep]
		\item 
		Traccia il punto P.
		\item 
		...
		\item 
		Denomina P' il punto, diverso da P, di intersezione fra la perpendicolare e la circonferenza. 
		\item 
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig014_simm_ass_iso.pgf}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig015_simm_ass_rette.pgf}
\end{minipage}\vspace{5pt}
...
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{\folder lbr/fig016_simm_ass_triangolo.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{\folder lbr/fig020_traslaz.pgf}
\end{wrapfigure}
...
\begin{procedura}
	Costruzione con riga e compasso del traslato di un punto P nella traslazione di vettore $\vec{v}$:
	\begin{enumerate} [nosep]
		\item 
		Traccia il punto P.
		\item 
		...
		\item 
		Costruisci la retta passante per P e parallela al vettore $\vec{v}$: denominala r.
		\item 
		Traccia la circonferenza di centro P e di raggio congruente al segmento del vettore $\vec{v}$.
		\item 
		Individua, fra i punti di intersezione della retta r con la circonferenza, quello per il quale il segmento orientato AA' risulti concorde al vettore $\vec{v}$: denominalo P' 
		\item 
	\end{enumerate}
	Il punto $P'$ così determinato è l'immagine di $P$ nella traslazione di vettore $\vec{v}$, 
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{\folder lbr/fig022_rotazione.pgf}
\end{wrapfigure}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig023_rotazione2.pgf}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.25\textwidth}
	\centering\input{\folder lbr/fig024_rotazione3.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig025_rotazione_iso.pgf}
\end{wrapfigure}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig026_rotazione_iso_dir.pgf}
\end{wrapfigure}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig030_es_comp_iso.pgf}
\end{minipage}\vspace{5pt}
\end{exrig}
...
Si possono dimostrare le seguenti proprietà, che riprenderemo nella parte successiva, in cui descriveremo le trasformazioni geometriche in un riferimento cartesiano ortogonale monometrico.
			...
			\begin{figure}[!htb]
				\begin{center}
					\noindent\begin{minipage}{0.49\textwidth}
						\centering\input{\folder lbr/fig004_es_piano_cartesiano.pgf}
						\caption{Esempio~\ref{es:8.3}}\label{fig:es8.3a}
					\end{minipage}
					\noindent\begin{minipage}{0.49\textwidth}
						\centering\input{\folder lbr/fig005_es.pgf}
...
\begin{exrig}
	\begin{esempio}
		...
		\begin{figure*}[!htb]
			...
			\centering\input{\folder lbr/fig017_es_piano_cartes_simm_ass.pgf}
		\end{figure*}
...
\begin{exrig}
	\begin{esempio}
		...
		\begin{figure*}[!htb]
			...
			\centering\input{\folder lbr/fig018_es_piano_cartes_simm_ass2.pgf}
		\end{figure*}
...
\begin{exrig}
	\begin{esempio}
		...
		\begin{figure*}[!htb]
			...
			\centering\input{\folder lbr/fig019_es_piano_cartes_simm_bisettr.pgf}
		\end{figure*}
...
\begin{wrapfigure}{r}{0.35\textwidth}
	...
	\centering\input{\folder lbr/fig021_es_piano_cartes_trasl.pgf}
\end{wrapfigure}
...
\subsubsection{\textbf{Descrizione analitica della composizione di trasformazioni geometriche}}
begin{exrig}
...
\begin{inaccessibleblock}[Figura: TODO]
\begin{figure}[!htb]
\centering\input{\folder lbr/fig027_es_piano_cartes_comp.pgf}
...
\begin{wrapfigure}{r}{0.5\textwidth}
	\centering\input{\folder lbr/fig028_controesempio.pgf}
\end{wrapfigure}
