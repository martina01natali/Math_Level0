...
cartesiano si dispongono lungo una curva.]
  \input{\folder lbr/001_trinomio.pgf}
...
\begin{inaccessibleblock}[I punti della tabella precedente riportati nel piano 
cartesiano si dispongono lungo una curva.]
  \input{\folder lbr/002_trinomio.pgf}
...
\begin{center}
 \begin{inaccessibleblock}[Parabola disegnata nel piano cartesiano.]
  \input{\folder lbr/003_trinomio.pgf}
...
\begin{minipage}{.69\textwidth}
 \begin{inaccessibleblock}[Parabola disegnata nel piano cartesiano.]
  \input{\folder lbr/004_coeff_a.pgf}
...
\begin{figure}
  \input{\folder lbr/005_quadrati.pgf}
...
\centering
  \input{\folder lbr/006_parabola.pgf}
...
\begin{inaccessibleblock}[Parabola di equazione $y=x^2$.]
\centering
  \input{\folder lbr/007_parabole.pgf}
...
\begin{inaccessibleblock}[Parabola di equazione $y=x^2$.]
\centering
  \input{\folder lbr/008_parabolarette.pgf}
...
\begin{inaccessibleblock}[Parabola di equazione $y=x^2$.]
\centering
  \input{\folder lbr/010_parabolaparabola.pgf}
...
\begin{inaccessibleblock}[Parabola di equazione $y=x^2$.]
\centering
  \input{\folder lbr/011_parabola3punti.pgf}
...
\begin{inaccessibleblock}[Parabola di equazione $y=x^2$.]
\centering
  \input{\folder lbr/012_parabolaverticepunto.pgf}
