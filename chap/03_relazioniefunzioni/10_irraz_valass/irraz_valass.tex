...
% \begin{wrapfloat}{figure}{r}{0pt}
% \begin{inaccessibleblock}[Descrizione immagine: Osso con incise alcune tacche 
% regolari]
...
\centering
\includegraphics[width=0.9\linewidth]{img/imm1} %[scale=0.35]{img/fig001.png}
\end{inaccessibleblock}
\caption{Retta}
\label{fig:abs_imm1}
\end{figure}
...
\begin{inaccessibleblock}[TODO]
\centering
\includegraphics[width=0.9\linewidth]{img/imm2} %[scale=0.35]{img/fig001.png}
\end{inaccessibleblock}
% \caption{Retta}
\label{fig:abs_imm2}
\end{figure}
...
\begin{inaccessibleblock}[TODO]
\centering
\includegraphics[width=0.9\linewidth]{img/imm3} %[scale=0.35]{img/fig001.png}
\end{inaccessibleblock}
% \caption{Retta}
\label{fig:abs_imm3}
\end{figure}
...
\textbf{2\textdegree CASO}: L'equazione si presenta nella forma:  
$|A(x)|=|B(x)|$\\
...
\begin{inaccessibleblock}[TODO]
\centering
\includegraphics[width=0.9\linewidth]{img/imm4} %[scale=0.35]{img/fig001.png}
\end{inaccessibleblock}
% \caption{Retta}
\label{fig:abs_imm4}
\end{figure}
...
\textbf{3\textdegree CASO}: La disequazione si presenta nella forma:  
$|P(x)|\geq k$ con $k> 0$\\
...
\begin{inaccessibleblock}[TODO]
\centering
\includegraphics[width=0.9\linewidth]{img/imm5} %[scale=0.35]{img/fig001.png}
\end{inaccessibleblock}
% \caption{Retta}
\label{fig:abs_imm5}
\end{figure}
