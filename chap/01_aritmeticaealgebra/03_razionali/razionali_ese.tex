...
\[\frac{3}{4}; \frac{3}{8}; \frac{1}{3}; \frac{5}{4}; \frac{2}{5}; 
\frac{6}{3}; \frac{5}{6}; %
\frac{12}{4}; \frac{19}{8}; \frac{16}{5}.\]
\end{esercizio}
...
\spazielenx
 ...
 \item $\dfrac{2}{3}\cdot\dfrac{2}{9}d$
...
Trasforma i numeri in notazione scientifica e scrivi nella stessa forma il 
risultato.
\[\frac{(0,00002)^2:30000000\cdot(0,1)^5}{4000 \cdot0,02:0,000003}.\]
\end{esercizio}
...
Trasforma i numeri in notazione scientifica e scrivi nella stessa forma il 
risultato.
\[\frac{(3000)^2:0,000003:20000000}{0,00002:0,00000004}.\]
\end{esercizio}
...
Trasforma i numeri in notazione scientifica e scrivi nella stessa forma il 
risultato.
\[\frac{(2000)^3 \cdot (0,000001)^5:20}{(0,0003)^2:3.000.000}.\]
\end{esercizio}
...
Trasforma i numeri in notazione scientifica e scrivi nella stessa forma il 
risultato.
\[\frac{4000^2\cdot 0,000012}{3\cdot 10^9\cdot 2000^3}.\]
\end{esercizio}
...
\officialeuro\ 70. Qual è la percentuale di sconto applicata?
\end{esercizio}
...
Qual era il prezzo senza sconto dell'armadio?
\end{esercizio}
...
{\frac{9}{5}}}$
\item $\displaystyle{\bigg(2+\frac{1}{2}\bigg)^{2}:\bigg(2-\frac{1}{2}
...
\begin{multline*}
 \bigg\{\bigg[\bigg(1-\frac{3}{5}\bigg)^3:\bigg(\frac{2}{5}\bigg)^{4}\bigg]:
 \bigg(\frac{3}{5}-1\bigg)^{2}%
\bigg\}^{6}\\
:\bigg\{\bigg[\bigg(\frac{4}{5}-\frac{2}{5}\bigg)^{4}\cdot\bigg(\frac{7}{5}-
1\bigg)^2\bigg]^{2}\cdot%
\bigg[\bigg(1-\frac{3}{5}\bigg)^{5}:\bigg(\frac{1}{5}+\frac{1}{5}\bigg)^{4}
\bigg]^{2}\bigg\}^{2}.
\end{multline*}
\end{esercizio}
...
ha~54 anni. Quanti anni ha Marco?
\end{esercizio}
...
Di quante pagine è formato il libro?
\end{esercizio}
...
$1000\unit{m\textsuperscript{3}}$ di acqua?
\end{esercizio}
...
% tenga conto che~1 \officialeuro\ valeva~1936,77 lire.
% \end{esercizio}
...
a)~25/2,\quad b)~21/5,\quad c)~25/4,\quad d)~15/4,\quad e)~1/10,\quad f)~5/2.

\paragraph{\ref{ese:3.67}}
$5\cdot10^{-30}$

\paragraph{\ref{ese:3.68}}
$3\cdot10^2$

\paragraph{\ref{ese:3.69}}
$1,3\cdot10^{-8}$

\paragraph{\ref{ese:3.70}}
$8\cdot10^{-18}$

\paragraph{\ref{ese:3.76}}
300.

\paragraph{\ref{ese:3.87}}
44\%.

\paragraph{\ref{ese:3.88}}
480.

\paragraph{\ref{ese:3.108}}
$21\unit{kg}$,~$9\unit{kg}$

\paragraph{\ref{ese:3.122}}
a)~$\pm\dfrac{3}{2}$,\quad b)~$\pm\dfrac{5}{2}$,\quad c)~$40$,\quad 
d)~$\dfrac{25}{48}$

% \paragraph{\ref{ese:3.123}}
% a)~$x=15; y=9$,\quad b)~$x=\dfrac{1}{2}; y=\dfrac{11}{4}$,\quad 
% c)~$x=\dfrac{5}{6}; %
% y=\dfrac{1}{2}$,\quad %
% d)~$x=\dfrac{1}{7}; y=\dfrac{1}{4}; z=\dfrac{3}{28}$

\paragraph{\ref{ese:3.143}}
a)~$-\dfrac{2}{11}$,\quad b)~$\dfrac{1}{24}$,\quad c)~$\dfrac{5}{6}$,%
\quad d)~$-\dfrac{3}{20}$

\paragraph{\ref{ese:3.144}}
a)~$-\dfrac{673}{1680}$,\quad b)~$\dfrac{31}{3}$,\quad c)~$\dfrac{1}{2}$,%
\quad d)~$\dfrac{55}{96}$

\paragraph{\ref{ese:3.145}}
a)~$-\dfrac{8}{5}$,\quad b)~$-\dfrac{46}{45}$,\quad c)~$1$,\quad 
d)~$\dfrac{13}{5}$

\paragraph{\ref{ese:3.146}}
a)~$\dfrac{11}{28}$,\quad b)~$\dfrac{15}{14}$,\quad c)~$\dfrac{1}{50}$,\quad %
d)~$\dfrac{5}{3}$

\paragraph{\ref{ese:3.147}}
a)~$\dfrac{5}{6}$,\quad b)~$10$,\quad c)~$\dfrac{13}{15}$,\quad 
d)~$\dfrac{11}{6}$

\paragraph{\ref{ese:3.148}}
a)~$\frac{1}{3}$,\quad b)~$-\dfrac{1}{12}$,\quad c)~$\dfrac{139}{40}$,\quad 
d)~$1$

\paragraph{\ref{ese:3.149}}
a)~$\dfrac{1}{6}$,\quad b)~$\dfrac{9}{20}$,\quad c)~$\dfrac{10}{3}$,\quad %
d)~$\dfrac{1}{3}$

\paragraph{\ref{ese:3.150}}
a)~$\dfrac{1}{144}$,\quad b)~$540$,\quad c)~$\dfrac{77}{50}$,\quad 
d)~$\dfrac{46}{9}$

\paragraph{\ref{ese:3.151}}
a)~$\dfrac{44}{3}$,\quad b)~$\dfrac{64}{9}$,\quad c)~$400$,\quad 
d)~$-\dfrac{2}{3}$

\paragraph{\ref{ese:3.152}}
a)~$\dfrac{100}{303}$,\quad b)~$10$,\quad c)~$-2~$,\quad d)~$-4$

\paragraph{\ref{ese:3.153}}
a)~$-\dfrac{2}{27}$,\quad b)~$-\dfrac{60}{11}$,\quad c)~$\dfrac{8}{81}$,\quad %

\paragraph{\ref{ese:3.154}}
$\bigg(\dfrac{2}{5}\bigg)^{-46}$

\paragraph{\ref{ese:3.155}}
a)~$2$,\quad b)~$1$,\quad c)~$\dfrac{8}{27}$,\quad d)~$\dfrac{25}{4}$

\paragraph{\ref{ese:3.156}}
a)~$-\dfrac{9}{2}$,\quad b)~$1$,\quad c)~$2$,\quad d)~$\dfrac{38}{45}$

\paragraph{\ref{ese:3.157}}
a)~$\dfrac{40}{37}$,\quad b)~$\dfrac{1}{15}$,\quad c)~$7$,\quad 
d)~$\dfrac{1}{3}$

\paragraph{\ref{ese:3.158}}
a)~$\dfrac{7}{3}$,\quad b)~$-\dfrac{8}{81}$

% \paragraph{\ref{ese:3.159}}
% a)~$100$,\quad b)~$-\dfrac{1}{2}$
\end{multicols}

\begin{multicols}{3}
% 
% \paragraph{\ref{ese:3.160}}
% $-\dfrac{5}{3}$
% 
% \paragraph{\ref{ese:3.161}}
% $\dfrac{5}{9}$
% 
% \paragraph{\ref{ese:3.162}}
% $-1$
% 
% \paragraph{\ref{ese:3.163}}
% $\dfrac{199}{10}$
% 
% \paragraph{\ref{ese:3.164}}
% $-\dfrac{3}{2}~$

\paragraph{\ref{ese:3.166}} 20.

\paragraph{\ref{ese:3.167}} 9.

\paragraph{\ref{ese:3.168}} 105.

\paragraph{\ref{ese:3.169}} 189.

\paragraph{\ref{ese:3.170}} 270.

\paragraph{\ref{ese:3.171}} 30,~18,~27.

\paragraph{\ref{ese:3.172}} 132,~66,~22.

\paragraph{\ref{ese:3.173}} 6.

\paragraph{\ref{ese:3.174}} 220.

% \paragraph{\ref{ese:3.175}} 76,~190.
% 
% \paragraph{\ref{ese:3.176}} \officialeuro\ 24,65.
% 
% \paragraph{\ref{ese:3.177}} 85\%.
% 
% \paragraph{\ref{ese:3.178}} 42,~24.
% 
% \paragraph{\ref{ese:3.180}} 45,~10,~18.
% 
% \paragraph{\ref{ese:3.181}} \officialeuro\ 600,~1/9.
% 
% \paragraph{\ref{ese:3.182}} 88.

% \paragraph{\ref{ese:3.184}} 126.
% 
% \paragraph{\ref{ese:3.185}} 1/100.
% 
% \paragraph{\ref{ese:3.186}} \officialeuro\ 54.

\paragraph{\ref{ese:3.190}} \officialeuro\ 737,50.

\paragraph{\ref{ese:3.191}} 25\%.

\paragraph{\ref{ese:3.193}} $5,36\unit{l}$

% \paragraph{\ref{ese:3.194}} $13,6\unit{cm}$,~$20,4\unit{cm}$
% 
% \paragraph{\ref{ese:3.195}} 20{\textdegree},~60{\textdegree},~100{\textdegree}.

\paragraph{\ref{ese:3.198}} \officialeuro\ 77; \officialeuro\ 69,30.

% \paragraph{\ref{ese:3.199}} No, perde l'1\% dei ricavi.

\paragraph{\ref{ese:3.201}}~21\%.

% \paragraph{\ref{ese:3.203}} \officialeuro\ 50.

\paragraph{\ref{ese:3.206}} \officialeuro\ 2,15.

\paragraph{\ref{ese:3.213}} 19,19\%.
