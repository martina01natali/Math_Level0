...
% \[(-f) + f = f + (- f) = F^0 = 0.\]
% \end{itemize*}
% Quest'ultima proprietà ci permette di trattare contemporaneamente l'operazione 
...
% % Si potrebbe scegliere un qualunque denominatore comune, ad esempio il prodotto 
