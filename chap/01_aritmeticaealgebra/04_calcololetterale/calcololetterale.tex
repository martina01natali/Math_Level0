...
\osservazione La formula ha carattere generale; essa serve ogni qualvolta si 
chiede di determinare la superficie di un rettangolo, note le misure delle 
dimensioni (base e altezza) rispetto alla stessa unità di misura.

In geometria si utilizzano tantissime formule che ci permettono di 
determinare perimetro e area delle figure piane, superficie laterale e totale 
...
% \ovalbox{\risolvii \ref{ese:9.13}, \ref{ese:9.14}, \ref{ese:9.15}, \ref{ese:9.16}}
...
% \ovalbox{\risolvii \ref{ese:9.26}, \ref{ese:9.27}, \ref{ese:9.28}, \ref{ese:9.29}, \ref{ese:9.30}, \ref{ese:9.31}, \ref{ese:9.32}}
...
=&\frac{15}{8}ab^{2}.
 ...
 \begin{esempio}
$\Bigg[\bigg(-{\frac{14}{16}}x^{2}y^{2}\bigg):\bigg(-{\frac{14}{4}}xy\bigg)\Bigg]^{3}+\frac{1}{2}xy\cdot{\frac{1}{4}}x^{2}y^{2}$.
...
% \ovalbox{\risolvii \ref{ese:9.33}, \ref{ese:9.34}, \ref{ese:9.35}, \ref{ese:9.36}, \ref{ese:9.37}, \ref{ese:9.38}, \ref{ese:9.39}, \ref{ese:9.40}, \ref{ese:9.41}, \ref{ese:9.42}}
...
Pertanto, senza effettuare i passaggi intermedi si ha~$\left(A+B\right)^{2}=A^{2}+2{AB}+B^{2}$.
...
di ciascun monomio per se stesso, un termine è costituito dal
...
\begin{center}
\input{\folder lbr/fig002_tart.pgf}
\end{center}
...
\begin{center}
\input{\folder lbr/fig003_tarti.pgf}
\end{center}
