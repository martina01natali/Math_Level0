...
Nel lancio di un dado sono possibili sei risultati, espressi dai numeri da 1 a 6 
...
$A{\cup}B{\cup}{\dots}F=\Omega $ e a due a due incompatibili 
$A{\cap}B=A{\cap}C{\dots}=B{\cap}C{\dots}=C{\cap}D{\dots}=D{\cap}E{\dots}=E{\cap
}F=\text{Ø}$) diremo che essi formano una \emph{partizione dello spazio degli 
eventi}. Gli eventi, identificabili da tutti i possibili sottoinsiemi di 
$\Omega$, sono dati dall'\emph{insieme delle parti} di $\Omega $ indicato con 
$\wp (\Omega ).$
\end{definizione}
...
considerando anche l'insieme vuoto $\emptyset $ che rappresenta l'evento 
...
La probabilità è dunque una misura del grado di fiducia associato al verificarsi 
di un evento e dipende dalle informazioni che si hanno a disposizione al momento 
...
ottiene dalla quota $q$ che l'individuo che procede alla valutazione è disposto 
...
\end{esempio}
\end{exrig}
% \ovalbox{\risolvii \ref{ese:9.6}, \ref{ese:9.7}, \ref{ese:9.8}, \ref{ese:9.9}, 
% \ref{ese:9.10}, \ref{ese:9.11}, \ref{ese:9.12}, \ref{ese:9.13}, \ref{ese:9.14}, 
% \ref{ese:9.15}, \ref{ese:9.16}, \ref{ese:9.17}, \ref{ese:9.18},}

% \vspazio\ovalbox{\ref{ese:9.19}, \ref{ese:9.20}, \ref{ese:9.21}, 
% \ref{ese:9.22}, \ref{ese:9.23}, \ref{ese:9.24}, \ref{ese:9.25}, \ref{ese:9.26}, 
% \ref{ese:9.27}.}
...
\begin{exrig}
\begin{esempio}
Nel lancio di un dado regolare calcolare la probabilità dell'uscita del numero 3 
o di un numero pari.
...
incompatibili, cioè: $A\cap B=\emptyset $: abbiamo $P(A\cup B)=\frac 1 6+\frac 3 
6=\frac 4 6$.
\begin{center}
...
Possiamo quindi affermare che dati due eventi incompatibili cioè tali che $A\cap 
...
% \ref{ese:9.29}, \ref{ese:9.30}, \ref{ese:9.31}, \ref{ese:9.32}, \ref{ese:9.33}, 
% \ref{ese:9.34}, \ref{ese:9.35}, \ref{ese:9.36}, \ref{ese:9.37} \ref{ese:9.38}.}
...
% \ref{ese:9.42}, \ref{ese:9.43}, \ref{ese:9.44}, \ref{ese:9.45}, \ref{ese:9.46}.}
...
\begin{center}
 \input{\folder lbr/fig011_alb.pgf}
\end{center}
...
indipendenti.
\begin{center}
 \input{\folder lbr/fig012_alb.pgf}
\end{center}
...
Il Cavalier de Méré pose al grande matematico francese Blaise Pascal nel 1654 il 
seguente problema.
\begin{problema}
...
B)=1-P(B)=\frac{35}{36}$. Dato che i lanci dei due dadi sono 24 e tutti tra loro 
indipendenti avremo:
 \[ p(\overline 
...
% \ref{ese:9.50}, \ref{ese:9.51}, \ref{ese:9.52}, \ref{ese:9.53}, \ref{ese:9.54}, 
% \ref{ese:9.55}, \ref{ese:9.56}, \ref{ese:9.57}, \ref{ese:9.58}, \ref{ese:9.59}.}
