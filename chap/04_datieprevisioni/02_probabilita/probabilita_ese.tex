...
%\subsubsection*{9.2 - Definizioni di probabilità}
\subsubsection*{\numnameref{sec:09_definizioni}}
...
% \begin{esercizio}[\Ast]
%  \label{ese:9.8}
% Per uno studente è indifferente ricevere 350 € senza condizioni, oppure un 
% motorino del valore 1500 € solo se sarà promosso. Qual è la probabilità che lo 
% studente attribuisce alla sua promozione? 
% \hfill $\left[P(E)=0,23\right]$
% \end{esercizio}
% 
% \begin{esercizio}[\Ast]
%  \label{ese:9.9}
% Uno studente è disposto a puntare 10 € per riceverne 60 solo se sarà interrogato 
% in matematica. Quale probabilità lo studente attribuisce all'eventualità di 
% essere interrogato in matematica?
% \hfill $\left[P(E)=0,17\right]$
% \end{esercizio}
...
% \begin{esercizio}[\Ast]
%  \label{ese:9.18}
% E' più facile vincere un premio acquistando un biglietto nella lotteria A che 
% prevede 10 premi di ugual valore su un totale di 5000 biglietti venduti o nella 
% lotteria B che prevede 7 premi su 3000 biglietti venduti?
% Se ogni premio per entrambe le lotteria ammonta a 1000 euro, quale dovrebbe 
% essere un prezzo equo per la lotteria A? Quale il prezzo equo per la lotteria B?
% \hfill [ Biglietto B;~Prezzo(A)=2€;~Prezzo(B)=2,23€]
% \end{esercizio}
...
%\subsubsection*{9.3 - Probabilità dell'unione di due eventi}
\subsubsection*{\numnameref{sec:09_unione}}
...
% \begin{esercizio}
%  \label{ese:9.37}
% Calcola la probabilità che lanciando un dado a sei facce esca un numero pari o 
% un multiplo di 3.
% \hfill $\left[...\right]$
% \end{esercizio}
...
% \begin{esercizio}
%  \label{ese:9.38}
% Nel gioco della tombola si estrae una pallina numerata da un sacchetto 
% contenente 90 palline numerate da 1 a 90. Calcola la probabilità che estraendo 
% la prima pallina essa riporti:
% \begin{itemize*}
...
%\subsubsection*{9.4 - Probabilità dell'evento complementare}
\subsubsection*{\numnameref{sec:09_complementare}}
...
%\subsubsection*{9.5 - Probabilità dell'evento intersezione di due eventi}
\subsubsection*{\numnameref{sec:09_intersezione}}
