...
\lstinputlisting[language=Python]{\folder lbr/00piano_vuoto.py}
...
\lstinputlisting[language=Python]{\folder lbr/01oggetti_di_base.py}
...
\lstinputlisting[language=Python]{\folder lbr/02intersezioni.py}
...
\lstinputlisting[language=Python]{\folder lbr/03altri_oggetti.py}
