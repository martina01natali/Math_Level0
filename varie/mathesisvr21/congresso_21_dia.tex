...
\affiancati{.48}{.48}{
otteniamo l'insieme completo dei \green{numeri reali}: \(\R\).
}{
% \vspace*{-1mm}
otteniamo il meraviglioso insieme dei \\\orange{numeri iperreali}: \(\IR\).
}
...
L'insieme dei numeri iperreali contiene anche gli \orange{infinitesimi} e 
gli \orange{infiniti} e è quindi adatto a risolvere in modo semplice i 
problemi relativi alla pendenza delle funzioni e alle aree delle superfici 
sottese alle funzioni.
...
\affiancati{.48}{.48}{
\hspace*{-7mm}\scalebox{.7}{\teoremafonda}
