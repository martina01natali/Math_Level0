...
%
%------------------------------
% Matematica dolce per i licei Linguistico e economico sociale, NSA
%
% Compilation:
% pdflatex --shell-escape nsa_20.tex
%------------------------------
%
...
\newcommand{\serie}{Matematica Dolce}
\newcommand{\titolo}{Calcolo infinitesimale}
\newcommand{\pdftitolo}{Matematica dolce\protect\\Calcolo infinitesimale}
\newcommand{\docvers}{\texttt{4.0.0}}
\newcommand{\edizione}{2020}
\newcommand{\Edizione}{Edizione}
\newcommand{\descr}{Testo per la Scuola Secondaria di $II$ grado
                    \protect\\ licei}
\newcommand{\oggi}{27 marzo 2020}
\newcommand{\mese}{marzo}
\newcommand{\anno}{2020}
\newcommand{\mcisbn}{-----------}
