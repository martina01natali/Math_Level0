%%%%%%%%%%%%%
% Claudoio Carboncini - Daniele Zambelli
%%%
...
\newcommand{\parte}[2]{
  ...
  \begin{center} \graphicspath {\folder}\end{center}
  \include{\folder #2}
}
...
\newcommand{\affiancatic}[4]{% 2 minipage affiancate con il contenuto centrato
% Esempio di chiamata:
% \affiancati{.48}{.48}{testo1}{testo2}
  \def \larga{#1}
  \def \largb{#2}
...
\DeclareRobustCommand{\Qz}{\mathbb{Q}^0}
\DeclareRobustCommand{\A}{\mathbb{A}}
\DeclareRobustCommand{\R}{\mathbb{R}}
\DeclareRobustCommand{\Rz}{\mathbb{R}^0}
\DeclareRobustCommand{\Rp}{\mathbb{R}^+}
\DeclareRobustCommand{\IR}{{}^*\hspace{-.12em}\mathbb{R}} % Iperreali
\DeclareRobustCommand{\C}{\mathbb{C}}
\DeclareRobustCommand{\IC}{{}^*\hspace{-.12em}\mathbb{C}} % Ipercomplessi
\DeclareRobustCommand{\K}{\mathbb{K}}
\DeclareRobustCommand{\effestar}{{}^*\hspace{-.15em}f}
% \newcommand{\fstar}[1][f]{{}^*\!#1}
\DeclareRobustCommand{\fstar}[1]{{}^*\hspace{-.25em}#1}
\DeclareRobustCommand{\ID}{I.D.}
\DeclareRobustCommand{\II}{I.I.}
...
\newcommand{\valass}[1]{\left| #1 \right|}
...
%--------------------------% Fne comandi per l'ambiente math
...
% 
% %--------------------------
% % Nuovo stile di teoremi.
% % Inserito in matsweetmem.cls
