...
% % con la sintassi di \foreach
  ...
  \rcom{\mix}{\max}{\miy}{\may}{gray!50, very thin, step=1}
  \tkzInit[xmin=\mix-0.3,xmax=\max+0.3,ymin=\miy-0.3,ymax=\may+0.3]
  \foreach \da/\fino/\func in \funzioni{
    \tkzFct[domain=\da:\fino, ultra thick, \col] {\func}}
  \foreach \px/\py/\pc in \pnti{
