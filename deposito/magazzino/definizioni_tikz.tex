...
%%%%--- TODO: aggiungere un parametro con il colore come in:
%%%%          nsa_corso_20/presentazioni/continuita_grafici.tex
%%%%          per ora le modifiche da fare sono solo in:
%%%%          funzioni02/funzioni.tex e in funzioni02/funzioni_grafici.tex
