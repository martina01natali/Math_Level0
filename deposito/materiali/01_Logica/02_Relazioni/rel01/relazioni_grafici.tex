...
\newcommand{\grafifunzbinarie}{% Grafi di alcune funzioni su coppie di numeri
  ...
  \grafoscatolasx{sub}{\(\tonda{+7,~+5}\)}{\(+2\)}
  \end{scope}
  \begin{scope}[xshift=100mm]
  \grafoscatolasx{sub}{\(\tonda{+5,~+7}\)}{\(-2\)}
  \end{scope}
  }
}
...
\newcommand{\grafidivisione}{% Grafi di divisione
  \disegno[10]{
  \grafoscatolasx{div}{\(\tonda{+7,~+3}\)}{\(+2\)}
  \begin{scope}[xshift=50mm]
  \grafoscatolasx{div}{\(\tonda{+7,~+3}\)}{\(+\dfrac{7}{3}\)}
  \end{scope}
  }
}
...
\newcommand{\grafidivmod}{% due esempi della funzione divmod
  \disegno[10]{
  \grafoscatolasx{divmod}{\(\tonda{+7,~+3}\)}{\(\tonda{+2,~1}\)}
  \begin{scope}[xshift=50mm]
  \grafoscatolasx{divmod}{\(\tonda{+7,~0}\)}{Errore}
  \end{scope}
  }
}
