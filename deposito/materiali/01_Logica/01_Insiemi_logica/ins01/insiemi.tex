...
\newcommand{\eseminter}[4]{% tabella relativa agli esempi sugli intervalli
  \emph{
...
%   a parole   & con i predicati & con le parentesi & sulla retta \\
%   \hline
%   \vspace*{-6mm} i numeri fino a~\(6\) escluso & 
%   \mbox{\vspace*{-16mm} \(x < 6\)} & 
%   \vspace*{-6mm} \(\intervaa{-\infty}{+6}\) & 
%   \disegno{\node at (0, 1) {~}; \raylconasse{0}{5}{2.5}{6}{white}{x}} 
%  \end{tabular}
% \end{center}
% \begin{center}
% \center
...
{\(-1 \le x < +4\)}
{\(\intervca{-1}{+4}\)}
{\disegno{\inticonasse{0}{5}{1}{4}{-1}{+4}{blue}{white}{x}}}
\end{esempio}
...
{\(+1 < x \le +4\)}
{\(\intervac{+1}{+9}\)}
{\disegno{\inticonasse{0}{5}{1}{4}{+1}{+9}{white}{blue}{x}}}
\end{esempio}
