...
\begin{esercizio}
\label{ese:6.22}
In base agli insiemi~\(A\) e~\(B\) rappresentati dai diagrammi di Venn, 
stabilisci 
...
% \begin{esercizio}
%  \label{ese:7.9}
% Dati gli insiemi~\(C\) delle lettere della parola ``GIARDINO'' e~\(D\) 
delle 
lettere 
% della
...
% \begin{esercizio}
%  \label{ese:7.11}
% Dati gli insiemi~\(C\) delle lettere della parola ``LIBRO'' e~\(D\) delle 
lettere 
% della
...
\begin{esercizio}
\label{ese:7.19}
Sia~\(E=\{x\in N/1\le x<3\}\), \(F=\{x/x\) è una vocale della parola 
``TELEFONO''\} 
...
\begin{esercizio}
 \label{ese:7.20}
Quanti sono gli elementi del prodotto cartesiano~\(A\times B\), dove~\(A\) 
ha~6 
elementi, \(B\) ne ha~3:
\begin{center}
...
\begin{esercizio}
 \label{ese:7.22}
Se~\(A\times B\) ha~5 elementi, da quanti elementi possono essere 
costituiti~\(A\) 
e~\(B\)?
\begin{center}
 \boxA\quad~1; 5 \quad\boxB\quad~3; 2 \quad\boxC\quad~6; 1 \quad\boxD\quad~2; 
3.
\end{center}
\end{esercizio}
...
\subsubsection*{\numnameref{sec:insiemi_intervalli}}
...
\intervcc{-4}{-1}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{5}{1}{4}{$-3$}{$+1$}{black}{black}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{5}{1}{4}{$+1$}{$+6$}{white}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{5}{1}{4}{$-2$}{$+5$}{black}{black}{x}}\\
        \(A \cup B; \quad A-C; \quad B \cap C\)\
\hfill [~\(\intervca{-3}{+1} \cup \intervac{+1}{+6}; \quad 
\intervca{-3}{-2}; \quad \intervac{+1}{+5}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{5}{1}{4}{$-4$}{$+4$}{white}{white}{x}}; 
\quad
\(B=\)\disegno{\rayrconasse{0}{5}{2.5}{$0$}{black}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{5}{1}{4}{$-0$}{$+9$}{white}{white}{x}}\\
        \(\overline{B}; \quad B \cap C; \quad A-C\)\
\hfill [~\(\intervaa{-\infty}{0}; \quad \intervaa{0}{+9}; \quad 
\emptyset;\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{5}{1}{4}{$-8$}{$+7$}{black}{white}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{5}{1}{4}{$-6$}{$+3$}{black}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{5}{1}{4}{$-3$}{$+9$}{black}{white}{x}}\\
        \(A \cap B; \quad B-C; \quad C-B\)\
\hfill [~\(\intervca{-6}{+3}; \quad \intervca{-6}{-3}; \quad 
\intervca{+3}{+9}\)~]
\item \(A=\{x|~x \in \R \sand  -3 < x \le +2\}; \quad 
        B=\{x|~x \in \R \sand  0 < x \le 8\}\); \\
      \(C=\{x|~x \in \R \sand  6 < x \le 7\}\)\\
        \(A-C; \quad A \cap C; \quad A \cap B\)\
\hfill [~\(\intervac{-3}{+2}; \quad \emptyset; \quad
\intervac{0}{+2}\)~]
\item \(A=\intervcc{-9}{-1}; \quad 
        B=\intervcc{-2}{0}; \quad 
        C=\intervaa{-4}{\infty}\)\\
        \(A \cup B; \quad A \cap B; \quad A-C\)\
\hfill [~\(\intervcc{-9}{0}; \quad \intervcc{-2}{-1}; \quad
\intervcc{-9}{-4}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{5}{1}{4}{$-2$}{$+2$}{white}{black}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{5}{1}{4}{$+5$}{$+8$}{black}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{5}{1}{4}{$+2$}{$+7$}{white}{black}{x}}\\
        \(A \cup C; \quad A-C; \quad C-B\)\
\hfill [~\(\intervac{-2}{+7}; \quad \intervac{-2}{+2}; \quad 
\intervaa{+2}{+5}\)~]
\end{enumerate}
\end{esercizio}
...
\(S\) è l'insieme degli iscritti al corso di Salsa, \(B\) l'insieme degli 
iscritti 
al corso di
...
bisogna frequentare almeno un corso oltre a quello di pianoforte. Se gli 
alunni:

\begin{enumeratea}
 \item che frequentano il corso di flauto sono~25 e non frequentano né quello 
di 
...
\boxA\quad~\(N>14\)\quad\boxB\quad~\(N<14\)\quad\boxC\quad~\(N>22\)\quad\boxD\
quad~\(N 
...
% \begin{esercizio}
% \label{ese:7.66}
% Siano dati i seguenti insiemi~\(C=\{x/x\) è una lettera della parola 
``REMARE''\}, 
