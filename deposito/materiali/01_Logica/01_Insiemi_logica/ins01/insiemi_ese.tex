...
\intervcc{-4}{-1}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-3$}{$+1$}{black}{black}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$+1$}{$+6$}{white}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-2$}{$+5$}{black}{black}{x}}\\
        \(A \cup B; \quad A-C; \quad B \cap C\)\
\hfill [~\(\intervca{-3}{+1} \cup \intervac{+1}{+6}; \quad 
\intervca{-3}{-2}; \quad \intervac{+1}{+5}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-4$}{$+4$}{white}{white}{x}}; 
\quad
\(B=\)\disegno{\rayrconasse{0}{5}{2.5}{$0$}{black}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-0$}{$+9$}{white}{white}{x}}\\
        \(\overline{B}; \quad B \cap C; \quad A-C\)\
\hfill [~\(\intervaa{-\infty}{0}; \quad \intervaa{0}{+9}; \quad 
\emptyset;\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-8$}{$+7$}{black}{white}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-6$}{$+3$}{black}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-3$}{$+9$}{black}{white}{x}}\\
        \(A \cap B; \quad B-C; \quad C-B\)\
\hfill [~\(\intervca{-6}{+3}; \quad \intervca{-6}{-3}; \quad 
\intervca{+3}{+9}\)~]
\item \(A=\{x|~x \in \insR \sand  -3 < x \le +2\}; \quad 
        B=\{x|~x \in \insR \sand  0 < x \le 8\}\); \\
      \(C=\{x|~x \in \insR \sand  6 < x \le 7\}\)\\
...
\intervcc{-9}{-4}\)~]
\item 
\(A=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$-2$}{$+2$}{white}{black}{x}}; 
\quad
\(B=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$+5$}{$+8$}{black}{white}{x}}; 
\quad
\(C=\)\disegno{\inticonasse{0}{-1.5}{+1.5}{$+2$}{$+7$}{white}{black}{x}}\\
