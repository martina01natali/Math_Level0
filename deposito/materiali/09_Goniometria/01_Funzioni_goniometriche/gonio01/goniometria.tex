...
\input{\folder goniometria_grafici.tex}
...
%  \begin{figure}[!h]
 \begin{minipage}[t]{.45\textwidth}
\begin{inaccessibleblock}[Rotazione che porta la semiretta a sulla semiretta 
b]
\begin{center}
...
% \begin{inaccessibleblock}[Una freccia curva in verso antiorario con un 
% segno 
...
% \begin{definizione}
% La \emph{componente orizzontale} \(u_{x}\) del vettore unitario inclinato 
% dell'angolo~\({\hat{\alpha}}\) sull'asse~\(x\), si chiama \emph{coseno 
% dell'angolo}
% \({\hat{\alpha}}\) in simboli~\(u_{x}=\cos \alpha\). Chiamiamo \emph{seno 
% dell'angolo} \({\alpha}\) la \emph{componente verticale} \(u_{y}\)
% del vettore unitario inclinato dell'angolo~\({\alpha}\) sull'asse~\(x\) in 
% simboli~\(u_{y}=\sin \alpha\).
% Scriviamo~\(\vec{u}=(\cos \alpha,\sin \alpha)\) o anche~\(B=(\cos 
% \alpha,\sin 
% \alpha)\).
% \end{definizione}
...
%     \label{fig:trigo_sin}
\funcwithlabel{7}{-7}{+7}{-1}{+1}{coscolor}{cos(x)}{y = \cos x}
\end{inaccessibleblock}
  \end{center}
%    \vspace{-24pt}
% \end{figure} 
...
\affiancati{.59}{.39}{
\[OHT \sim OCP \sRarrow \frac{HT}{CP} = \frac{OH}{OC} \sRarrow 
HT = \frac{OH \cdot CP}{OC}\]

Considerando che:
\begin{itemize*}
 \item \(HT = \tan \alpha\);
 \item \(OH = 1\);
 \item \(CP = OS = \sin \alpha\);
 \item \(OC = \cos \alpha\);
\end{itemize*}
possiamo operare le sostituzioni ottenendo:
\(\tan \alpha = \dfrac{\sin \alpha}{\cos \alpha}\)
}{
\begin{inaccessibleblock}[La circonferenza goniometrica.]
\begin{center}\scalebox{1}{\circgoniopertangente}\end{center}
\end{inaccessibleblock}
}
...
ricordarci il valore delle corrispondenti funzioni circolari. 
...
\begin{inaccessibleblock}[Quadrato e diagonale.]
\begin{center}
\mbox{}
\disegno{\quadratopitagorico{4}{\(l\)}{\(l \cdot \sqrt{2}\)}}
\vspace{3mm}
\mbox{}
\vspace{3mm}
\disegno{\quadratopitagorico{4}{\(d \cdot \frac{\sqrt{2}}{2}\)}{\(d\)}} 
\end{center}
\end{inaccessibleblock}
 \end{minipage}
...
\begin{inaccessibleblock}[Triangolo equilatero.]
\begin{center}
\disegno{\triequipitagorico{6}}
\end{center}
\end{inaccessibleblock}
 \end{minipage}
...
\affiancati{.39}{.59}{
  ...
  e le intersechiamo con la retta~\(y=\dfrac{1}{2}\).
...
\begin{inaccessibleblock}[Soluzione grafica dell'equazione: 
    \(\sin x = \dfrac{1}{2}\).]
    \scalebox{.9}{\input{\folder lbr/017_equazione01.pgf}}
%     \caption{Soluzione grafica di: \(\sin x = \dfrac{1}{2}\)}
...
\(-2 \cos x  = \sqrt{2} \quad \Rightarrow \quad 
...
\begin{inaccessibleblock}[Soluzione grafica dell'equazione: 
    \(\cos x = \dfrac{\sqrt{2}}{2}\).]
    \scalebox{.9}{\input{\folder lbr/018_equazione02.pgf}}
%     \caption{Soluzione grafica di: \(\cos x = \dfrac{\sqrt{2}}{2}\)}
