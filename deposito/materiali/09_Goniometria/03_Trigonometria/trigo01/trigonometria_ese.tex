...
e un angolo acuto.]
\begin{center}\scalebox{.8}{\triangoliese}\end{center}
...
dei lati più corti.]
\begin{center} \scalebox{.9}{\ottusangolo} \end{center}
\end{inaccessibleblock}
\end{center}
% \begin{multicols}{2}
 \begin{enumeratea}
...
\numnameref{subsec:trigo_quadrilateri}
...
\begin{center} \scalebox{.9}{\collina} \end{center}
\end{inaccessibleblock}
\end{center}
\hfill [\(597,27\unit{m}\)]
\end{esercizio}
...
\begin{center} \scalebox{.9}{\percorsoa} \end{center}
\end{inaccessibleblock}
\end{center}
\hfill [\(44\unit{Km}\)]
\end{esercizio}
...
\begin{center} \scalebox{.9}{\percorsob} \end{center}
\end{inaccessibleblock}
\end{center}
\hfill [\(5,91\unit{Km}\)]
\end{esercizio}
...
\begin{center} \scalebox{.9}{\percorsoc} \end{center}
\end{inaccessibleblock}
\end{center}
\hfill [\(25,38\unit{Km}\)]
\end{esercizio}
...
\begin{esercizio}[\Ast]
\label{ese:G.49}
Dalla cima di un palco alto~\(1,30\unit{m}\) un tizio alto~\(1,70\unit{m}\) 
osserva 
...
\emph{Attenzione}: osservare un oggetto sotto un angolo~\(\hat{\alpha}\) 
significa 
...
\begin{center} \scalebox{.9}{\circuito} \end{center}
\end{inaccessibleblock}
\end{center}
\hfill [\(25,36\unit{m}\)]
\end{esercizio}
