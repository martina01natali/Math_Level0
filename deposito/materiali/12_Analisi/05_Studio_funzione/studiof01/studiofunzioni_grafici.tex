...
\newcommand{\grafeseparti}[4]{%
  \def \minx{#1}
  \def \miny{#2}
  \def \funcs{#3}
  \def \punti{#4}
  \disegno[\uni]{
% Il pezzo di codice commentato non funziona
%     \grafparti{\minx}{\minx+16}{\miny}{\miny+13}{green!50!black}
%               {\funcs}
%               {\punti}
% Il codice seguente sì???!!!???
  \grafparti{\minx}{\minx+16}{\miny}{\miny+13}{green!50!black}
            {#3}
            {#4}
  }
