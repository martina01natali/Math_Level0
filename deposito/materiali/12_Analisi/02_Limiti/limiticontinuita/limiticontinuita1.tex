...
\begin{itemize} [noitemsep]
\item 
la funzione è continua e % in quell'intervallo;
\item 
...
Quando \(x\) si avvicina a \(-3\), la funzione da un lato diventa sempre più 
...
\begin{center}\scalebox{1.0}{\limitigraficob}\end{center}
}
...
\begin{center} \scalebox{.9}{\limitefinitodef} \end{center}
}
