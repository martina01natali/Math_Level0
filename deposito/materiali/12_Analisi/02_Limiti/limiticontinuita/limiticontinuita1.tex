...
l'angolo \(\delta\)) si avvicina a zero, seguiamo, in aggiunta a quanto 
abbbiamo visto nella pagina precedente, il geniale ragionamento di Archimede, a 
proposito del rapporto fra circonferenza e diametro.\\
...
\[sen \delta \approx \dfrac{1}{2}\dfrac{2\pi r}{N}=\dfrac{l}{2},\quad \text{con 
...
Possiamo ripetere un discorso analogo anche per la metà del lato infinitesimo 
...
individuare l'arco \(CD\) che appare come un segmento verticale, con i due raggi 
in arrivo che risultano paralleli. Con un nuovo ingrandimento infinito (M2) sul 
punto \(C\) possiamo cogliere la distinzione fra il coseno e il raggio, cioè 
\(BC=1-\cos\delta\), che, come ha ben spiegato l'Agnesi, è un segmento 
infinitesimo del secondo ordine.\\
In M3 abbiamo la stessa grandezza \(DE~=~BC\) sul secondo lato 
dell'angolo \(\delta\). 
\end{minipage}
\hfill
...
\end{minipage}
Puntiamo allora M4 su \(E\) per distinguere la 
differenza \(CF-CE\) fra il seno e la tangente, che ora possiamo cogliere 
perché l'ingrandimento complessivo è del terzo ordine.
