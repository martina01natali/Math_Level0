...
La forma della funzione viene chiamata: \emph{grafico della funzione}.
\end{osservazione}
...
\begin{center}\disegno{\graficoxy{-5}{+5}{-2}{+5}{-x**2+4}}\end{center}
\end{minipage}
...
\end{esempio}
\begin{center}\disegno{\graficoxy{-5}{+5}{-1}{+10}{2**(x+1)}}\end{center}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
da \(+2\).
\end{esempio}
\begin{center}\disegno{\graficoxy{-5}{+5}{-4}{+5}{-x**2+3}}\end{center}
\end{minipage}
...
\begin{center}\disegno{\graficoxy{-5}{+5}{-4}{+5}{x**3 -4*x}}\end{center}
\end{esempio}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
...
\end{esempio}
\begin{center}\disegno{\graficoxy{-5}{+5}{-6}{+2}{-exp(x)}}\end{center}
\end{minipage}
...
Tutti gli esempi precedenti.
\end{esempio}
\end{minipage}
\hfill
\begin{minipage}{.49\textwidth}
\begin{center}
\disegno{\graficoxy{-5}{+5}{-3}{+4}{.1*x**3+1}}
\end{center}
\end{minipage}
...
\begin{center}
\disegno{\graficoxy{-1}{+9}{-4}{+4}{log(x)/log(2)}}
\end{center}
\end{minipage}
