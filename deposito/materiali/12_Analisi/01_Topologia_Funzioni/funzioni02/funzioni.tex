...
\item Dimostra le congetture precedenti.
\item Scrivi la funzione quadratica e stampane 10 valori.
\item Scrivi la funzione reciproca e stampane 10 valori.
\item Scrivi una funzione che diminuisca all'aumentare di $x$.

## Visualizzazione su due assi
...
![Assi che rappresentano dominio e 
codominio]
(https://drive.google.com/uc?export=view&id=1X1-HmGdedOLcMocixQcWLeTcY9kZDaX
U)
...
![Assi che rappresentano dominio e 
codominio]
(https://drive.google.com/uc?export=view&id=1_bmSla7TNuDFd83Oh7kqPdQqyU2FM7K
Z)
...
interi, 
ma la funzione è definita anche per qualunque altro numero reale.
...
2\. La metà di $x$ aumentata di tre.

3\. Il doppio di $x$ aumentato di tre.

4\. L'opposto di $x$ aumentato di tre.

5\. L'opposto della metà di $x$ aumentato di tre.

6\. L'opposto del doppio di $x$ aumentato di tre.
"""

def f_2(x):
   ``""Restituisce la metà di x aumentata di 3."""
  return x / 2 + 3

tabella_o(f_2, range(-8, +7))

"""E il corrispondente grafico con due assi:

![Grafico con due assi della funzione f_2(x) = 
0.5*x+3]
(https://drive.google.com/uc?export=view&id=13gH85RVwwNp1y2brHrYuEqu9gPOs_cM
r)
"""

def f_3(x):
   ``""Restituisce il doppio di x aumentato di 3."""
  return 
...
![Grafico con due assi della funzione f_3(x) = 
0.5*x+3]
(https://drive.google.com/uc?export=view&id=1P4PVZDgigAiidoLsvjC9oNUGLMA4azk
5)
"""

def f_4(x):
   ``""Restituisce l'opposto di x aumentato di 3."""
  return 
...
![Grafico con due assi della funzione f_3(x) = 
0.5*x+3]
(https://drive.google.com/uc?export=view&id=1thzscXIRllzYDkY1C1npMkmwokgZ8pN
o)
"""

def f_5(x):
   ``""Restituisce l'opposto della meta' di x aumentato di 3."""
  return 
...
![Grafico con due assi della funzione f_3(x) = 
0.5*x+3]
(https://drive.google.com/uc?export=view&id=1SLf1ul-zGxH47loXYPjQDZqrmf8hXd8
5)
"""

def f_6(x):
   ``""Restituisce l'opposto del doppio di x aumentato di 3."""
  return 
...
![Grafico con due assi della funzione f_3(x) = 
0.5*x+3]
(https://drive.google.com/uc?export=view&id=1Ca-RhjREk_wtlzYiidIA25TQJrhcXj-
6)

## Visualizzazione cartesiana
...
![Rappresentazione di una coppia argomento-risultato nel piano 
cartesiano]
(https://drive.google.com/uc?export=view&id=1hzy8bIHO3vEM8_qdI2X8r_u1s7Zp1tF
w)
...
![Grafico cartesiano della funzione f_6(x) = 
-2*x+3]
(https://drive.google.com/uc?export=view&id=1DQ4dYIB3RX74YdN9U5OiovU1owyqg-B
F)
...
![Grafico cartesiano della funzione f_6(x) = 
-2*x+3]
(https://drive.google.com/uc?export=view&id=1DxWI-pVYiP_osc3esjCyMT0Iaciye6p
_)
...
### Come far disegnare il grafico a Python
...
più 
semplice è quella di fare delle modifiche e vederne l'effetto.

---
"""

"""
Prima di poter eseguire questa cella, deve essere stata eseguita,
almeno una volta in questa sessione,
la cella in cui viene definita la funzione  ``grafico''.
"""
...
* $f_0: x \mapsto - \dfrac{3}{2} x$
* $f_1: x \mapsto \dfrac{6}{x}$
* $f_2: x \mapsto - \dfrac{5}{4} x -2$
* $f_3: x \mapsto x^2$
* $f_4: x \mapsto - \dfrac{1}{2} x^2 -2$
* $f_5: x \mapsto - \dfrac{x-2}{3x+4}$
