...
numeri, ma per fare questo dobbiamo dotarla di: \quad 
1.~un verso; \quad 2.~un'origine; \quad 3.~un'unità di misura.
...
% \end{enumerate}
% \begin{center}
% 1.~un verso; \qquad 2.~un'origine; \qquad 3.~un'unità di misura.
% \end{center}
