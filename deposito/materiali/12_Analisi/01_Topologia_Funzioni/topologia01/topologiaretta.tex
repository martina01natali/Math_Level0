...
viceversa a d ogni punto della retta un numero, dobbiamo anche dotare la 
retta di:
...
numeri più grandi di qualunque numero considerato è stato inventato un 
apposito simbolo: \(+\infty\) e, per numeri più piccoli di qualunque 
numero considerato, il simbolo \(-\infty\).
\end{newoss}
}{
\begin{newoss}{}{}
...
\begin{newdef}{}{}
Si dice \emph{monade} di un punto \(P\) (o numero \(x_P\)) l'insieme di tutti 
i punti (o i numeri) infinitamente vicini a \(P\) (o a \(x_P\)). 
\end{newdef}
}
