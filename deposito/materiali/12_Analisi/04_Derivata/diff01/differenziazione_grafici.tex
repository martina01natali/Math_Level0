...
\newcommand{\temperaturepunti}{% 
  ...
  \foreach \xp/\yp in {1/4, 2/3, 3/0, 4/0, 5/-1, 6/-3, 
                       7/-3, 8/-3.5, 9/-4.5, 10/-4.5, 
                       11/-3, 12/0} 
...
\newcommand{\temperaturea}{% 
  ...
  \disegno[5]{
    \rcom{-0}{+13}{-5}{+4}{gray!50, very thin, step=1}
    \temperaturepunti
  }
}
...
\newcommand{\temperatureb}{% 
  ...
  \disegno[5]{
    ...
    \draw[ultra thick, orange!50!black] plot[smooth] 
      coordinates {(1, 4) (2, 3) (3, 0) (4, 0) (5, -1) (6, -3) (7, -3) 
                   (8, -3.5) (9, -4.5) (10, -4.5) (11, -3) (12, 0)};
    \temperaturepunti
    \microscopio{\pm}{1.0}{30}{-120}{2}{(8.5, 3.5)}
                {\footnotesize{\(\times 3600\)}}
    \foreach \xp/\yp in {4.5/2.9, 5.5/2.3, 6.5/1.6, 7.5/0.8} 
      \filldraw (\xp, \yp) [orange!50!black] circle(2pt);
  }
}
