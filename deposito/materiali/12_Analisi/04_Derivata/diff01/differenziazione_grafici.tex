...
\newcommand{\seno}{ %
    ...
    \begin{scope}[thick, dashed, color=blue!40!black]
...
\newcommand{\tangentiseno}{% 
    % definita in intervallo 0-inf.
      ...
      \rcom{-4}{+6}{-2}{+2}{gray!50, very thin, step=1}
     \tkzInit[xmin=-4.3, xmax=+6.3, ymin=-4, ymax=4]
     \tkzFct[ultra thick, color=blue!50!black, domain=-4.3:+6.3]{cos(x)}
      }
}
...
\newcommand{\tangenticoseno}{% 
    % definita in intervallo 0-inf.
      ...
      \rcom{-4}{+6}{-2}{+2}{gray!50, very thin, step=1}
     \tkzInit[xmin=-4.3, xmax=+6.3, ymin=-4, ymax=4]
     \tkzFct[ultra thick, color=blue!50!black, domain=-4.3:+6.3]{-sin(x)}
      }
}
