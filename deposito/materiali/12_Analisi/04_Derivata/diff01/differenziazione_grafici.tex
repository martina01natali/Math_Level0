...
\newcommand{\diffcomposta}{%differenziale di f composta
  ...
  \end{scope}
   ...
   \tkzFct[ultra thick, color=blue!50!black, domain=0:7.3]{-.33*x-.66}
   \tkzFct[ultra thick, color=blue!50!black, domain=0:8.3]{x*x/8}
 ...
 \begin{scope}[black, font=\fontsize{6}{6}]       
  \microscopio{(0, -1.5)}{2}{220}{0}{3}{(-4, -6)}{\(\times \infty\)} %mic. per 
dt
 ...
 \microscopio{(2.5, -1.5)}{1}{-90}{90}{3}{(4, -8)}{\(\times \infty\)} %mic. per 
dt/du
 \draw [ultra thick, color=blue!50!black] (-.3, -4.5) -- (5.3, -6.5);
 ...
 \draw  (.5, -5.5) node {\(dt\)};
    ...
    \microscopio{(2.4, 0)}{1.5}{10}{200}{3}{(8.5, -1.5)}{\(\times \infty\)} 
%mic. per du
   ...
   \microscopio{(2.5, .8)}{3}{90}{-90}{3}{(6, 8.5)}{\(\times \infty\)} %mic. 
per du/dv
   \tkzFct[ultra thick, color=blue!50!black, domain=0.1:5.2]{.6*x+5}
