...
Calcolando le derivate abbiamo  imparato ad analizzare la forma delle 
curve-grafici delle funzioni regolari. Anche se più avanti renderemo più 
generali queste nozioni, finora sappiamo che:
...
1^2}{\sqrt{(1^4+1)^3}}=\sqrt{2}\simeq 0,707\\
...
destra che a sinistra, curvatura diminuisce rapidamente.
\end{esempio}
\begin{esempio}
...
semicirconferenza di raggio \(r=3\), nel semipiano \(y\geqslant 0\).
\begin{align*}
...
attraverso il raggio del cerchio che in quel punto approssima la curva al meglio 
(cioè per quanto ci consente derivare fino alla seconda derivata). Tale cerchio 
è chiamato \emph{cerchio osculatore}.
