...
anche nello studio delle scienze umane e sociali. Le funzioni che si usano in
tutti questi ambiti in genere sono state definite sperimentalmente. Alcune 
delle questioni di carattere più matematico di cui ci siamo occupati, come la
continuità e gli infinitesimi, ai fini pratici diventano meno rilevanti, almeno
fino a quando questo non ingeneri problemi.\\
In molte circostanze è di grande utilità l'equazione alle differenze 
$\Delta f(x)\cong f'(x_0)\Delta x$, anche nella forma
$\Delta x \cong \dfrac{\Delta f(x)}{f'(x_0)}$. La sua utilità viene dal fatto
che si tratta di un'equazione di primo grado in $\Delta x$, perché accettando
l'approssimazione si eliminano le differenze di ordine superiore.
