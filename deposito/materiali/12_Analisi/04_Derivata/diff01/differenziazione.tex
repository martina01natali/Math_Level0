...
discusso (\ref{subsubsec:insnum_expstar} il comportamento di queste funzioni
...
\begin{proof}
 Usiamo una trasformazione appresa con lo studio dei logaritmi e applichiamo la
 regola \ref{subsec:diff01_dericomp}:
...
(vedi \ref{subsubsec:insnum_fseno}) che per angoli infinitesimi il seno e 
...
\begin{osservazione}
  ...
  in cui si fa uso delle forme indeterminate discusse in 
  \ref{subsubsec:insnum_fseno}. Alla fine basta applicare la funzione $\pst{}$.
\end{osservazione}
\begin{osservazione}
...
sfruttiamo la regola della derivata di un quoziente (paragrafo 
\ref{sec:diff01_regolederivate}).
\begin{teorema}
