...
Per provare a 
rispondere, ricordiamo il grafico \ref{graf:temperature}: lì gli incrementi 
delle temperature, ora per ora, causano le inclinazioni dei segmenti.  
Le pendenze di quei segmenti si possono calcolare anche con le regole 
appena viste, perché nei segmenti, come nelle rette, la pendenza 
corrisponde al coefficiente angolare. Dimostriamolo. 
...
Si tratta di un risultato molto utile per individuare le pendenze nei nei 
nostri grafici. Per visualizzare la pendenza di una curva in un suo punto 
