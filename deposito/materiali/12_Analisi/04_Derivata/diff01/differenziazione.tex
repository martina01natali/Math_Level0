...
\(f'\) quindi è la formula che consente di calcolare tutte le pendenze 
...
%\end{inaccessibleblock}
%\label{graf:temperaturea}
\textbf{TABELLA E GRAFICO FUNZIONE E DERIVATA}
\end{minipage}
\end{esempio}
...
Questo ci conferma che, scelta la funzione \(f\), la sua derivata \(f'\) è la 
funzione di \(x\) che genera l'insieme delle pendenze di \(f\).

A questo punto andiamo alla ricerca delle regole che ci aiutano a derivare 
rapidamente i vari tipi di funzione che conosciamo.
