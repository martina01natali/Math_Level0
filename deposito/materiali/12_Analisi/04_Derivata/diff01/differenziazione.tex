...
sua  derivata, se esiste, è la somma fra due prodotti: la derivata della
 prima funzione per la seconda più la prima funzione per il la 
...
disegno che spesso si usa per rappresentare il prodotto fra due binomi. Anche 
noi ci regoliamo in questo senso, quindi usiamo il disegno 
come guida, senza soffermarci sui suoi limiti: infatti si potrebbe discutere 
sul fatto che un'area rappresenti un prodotto tra funzioni.
...
\end{align*}
Per ipotesi abbiamo scritto che esistono le derivate delle tre funzioni, perciò 
...
\begin{esempio}
 Deriva la funzione \(f(x)=12x\)

 \end{esempio}

\begin{osservazione}
 la funzione lineare e gli esempi precedenti
\end{osservazione}

\begin{esempio}
 Deriva la funzione \(f(x)=x^2\) con la regola appena appresa
