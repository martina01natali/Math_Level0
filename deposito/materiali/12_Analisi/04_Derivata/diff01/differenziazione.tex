...
\end{teorema}
\noindent Ipotesi: \(\mathit{A}(x)=b(x)\cdot h(x)\) \text{ e esistono }
\(\mathit{A'}(x),\ b'(x),\ h'(x)\).\\ 
Tesi: \(\mathit{A'}(x)=b'(x)\cdot h(x)+b(x)\cdot h'(x)\).
...
La figura viene usata spesso per raffigurare il prodotto di due 
binomi. Sarebbe da dimostrare che sia giusto usarla anche per il prodotto 
fra le funzioni e i loro differenziali, ma per i nostri scopi accettiamo 
