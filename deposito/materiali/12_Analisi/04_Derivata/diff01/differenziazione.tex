...
\begin{esempio}
Calcola le derivate successive di \(f(x)=x^4 -x^3 +3x^2 -2x +5\).\\
...
% Penso che vada:
\begin{align*}
x_{O_P} & = x_P +r \cos\beta = x_P +5,59 \cos 153,4^\circ = 
            1 -5,59 \cdot 0,89 \simeq -3.98\\
y_{O_P} & = y_P +r \sen\beta = y_P +5,59 \sen 153,4^\circ =
            1 +5,59 \cdot 0,45 \simeq 3.52
\end{align*}
\begin{center}  \scalebox{1}{\osculatoreesea} \end{center}
