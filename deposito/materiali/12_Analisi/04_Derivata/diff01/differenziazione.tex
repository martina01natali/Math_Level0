...
dell'insieme degli Iperreali e sull'applicazione diffusa del \emph{principio di 
estensione naturale} agli Iperreali delle proprietà utili, che sono vere 
...
preciso per ogni valore di $t$ e per ogni valore $dt$, un iperreale finito che 
è 
...
Alle 23 la temperatura iniza a calare di \(1^\circ C\) rispetto alle 24, quindi 
l'incremento \( \Delta T=-1\). \\
Fra le \(5\) e le \(7\) l' incremento \(\Delta T= 5 ^\circ C\). Ma stavolta 
...
\begin{minipage}{0.48\textwidth}
% \begin{center}
Immaginiamo ora di avere esigenze scientifiche molto raffinate e di predisporre 
...
e individuare molti più dettagli, se potessimo visualizzare le 
diverse pendenze.
%\end{center}
\end{minipage}
 \hfill
...
%>>>>>>> b5e6d815548194f1973585214ed69d15077ee464
...
$v_{AB}|_{t=4}=\pst{\dfrac{ds_{AB}}{dt}}\bigg|_{t=4}=\dfrac{800(4t-2)}{2\sqrt{2t
