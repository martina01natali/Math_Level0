...
$k$  & 0 &   $\tg x$ & $\dfrac{1}{cos^2 x}=\tg^2 x +1$\\[.5em] \hline 
&&&\\[-.5em]
$x$ & 1 &   $\log_a x$ & $\dfrac{1}{x\ln a}$\\[.5em] \hline
$x^\alpha$ & $\alpha x^{\alpha-1}$ &   $\ln x$ & $\dfrac{1}{x}$\\[.5em] \hline
$\sen x$ & $\cos x$ &   $a^x$ & $a^x\ln a$\\[.5em] \hline
