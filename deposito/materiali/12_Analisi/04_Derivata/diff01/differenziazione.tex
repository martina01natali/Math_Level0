...
così:
\(t\in \quadra{0;\ 3,6}\). 
Il verso delle parentesi quadre è importante, indica se 
l'estremo dell'intervallo è un valore possibile, cioè se è incluso.\\
...
\[df(x)|_{x=0} = f(0+dx)-f(0)=\sqrt{0+dx}-\sqrt{0}=\sqrt{dx}\]
...
differenza;
 \item $d(f\cdot g)\sim df\cdot g+f\cdot dg$\tab differenziale del prodotto;
