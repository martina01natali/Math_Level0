...
uno fra gli infiniti infinitesimi di $x_0$. A livello microscopico, la 
curvatura del grafico non esiste,  per cui il grafico e la 
...
appaiono come rette parallele. Il punto di coordinate reali più vicino a 
quello raffigurato, nella rappresentazione doppiamente ingrandita, si trova a 
...
%   \hfill
%  \begin{minipage}[]{.55\textwidth}
%  Allontanandosi dal punto nel quale si calcola la derivata, le differenze della
%  funzione, calcolate a partire dal punto di tangenza, possono essere molto diverse
%  dalle differenze calcolate lungo la tangente.
%  \end{minipage}
% \end{inaccessibleblock}
% \label{}
