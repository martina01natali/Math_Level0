...
\begin{itemize}
 \item La pendenza è un numero reale che consente di capire con quale 
...
\item si scrive e si calcola il Rapporto Differenziale (\(RD\));
\item se esiste e è finito se ne calcola la parte standard;
\item si controlla se la parte standard ha sempre lo stesso valore per 
qualsiasi variazione infinitesima diversa da zero, della variabile \(x\);
\item se si supera il punto precedente, il numero reale ottenuto è la 
pendenza.
\end{enumerate}
\end{itemize}
\begin{osservazione}
Ai punti 4 e 5 dell'elenco si indicano alcuni controlli importanti.
Vediamone i motivi.
 \begin{itemize}
