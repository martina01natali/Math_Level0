...
quindi non possiamo essere certi su quale sia il tipo del risultato che fornisce.\\
...
\begin{esempio}
  ...
  \dfrac{2}{5}\tonda{5dx+(dx)^2}-\dfrac{3}{5}dx=$\\
  $=2dx+\dfrac{2}{5}(dx)^2-\dfrac{3}{5}dx=
  \dfrac{7}{5}dx+\dfrac{2}{5}(dx)^2$\\
  Raccogliendo $dx$ nel differenziale della funzione, il rapporto differenziale 
  si calcola facilmente:\\
  $\dfrac{d(f(x)}{dx}\bigg|_{x=5}=\dfrac{\tonda{\dfrac{7}{5}+\dfrac{2}{5}dx}dx}
  {dx}=\dfrac{7}{5}+\dfrac{2}{5}dx$.\\
