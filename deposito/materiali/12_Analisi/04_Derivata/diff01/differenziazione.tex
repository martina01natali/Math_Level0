...
Il metodo del rapporto differenziale porta a soluzioni semplici solo nei casi 
praticamente inutili, quando si applica alle rette (funzioni polinomiali di 
primo grado). In tutti gli altri casi il risultato iperreale contiene 
infinitesimi che possone essere scomodi da gestire negli sviluppi successivi.
...
vorremmo poter fare sempre così.\\
...
\begin{definizione}
  Si dice \emph{derivata} della funzione $f(x)$ nel punto $\punto{x_0}{f(x_0)}$
  la parte standard del rapporto differenziale della funzione, calcolato nello 
  stesso punto. La derivata si indica tradizionalmente con $f'(x_0)$.\\
...
maggior parte dei casi possiamo trascurare.\\
...
\subsubsection{nome e simbolo}
\subsubsection{derivata e tangente}
\subsubsection{derivate fondamentali}
\subsubsection{la derivata è una funzione}
