...
Il caso in cui \(y=f(x)=\sqrt[m]{x^n}=x^\frac{m}{n}\) si  dimostra con lo 
in modo analogo, anche avvalendosi del Teorema \ref{teo:diff01_dericomp}.
La dimostrazione valida per qualsiasi esponente reale è a 
