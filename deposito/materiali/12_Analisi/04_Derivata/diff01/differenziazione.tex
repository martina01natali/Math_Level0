...
\(OA = 1; \quad AB = d(\arctan x); \sstext{e} OC = \sqrt{1 +x^2}\) \quad 
si ottiene:
\[d(\arctan x) = AB = 
...
\(OH = 1; \quad CD = dx; \sstext{e} OC = \sqrt{1 +x^2}\) \quad 
si ottiene:
...
possibile calcolare la derivata di queste funzioni applicando il teorema della 
...
vedi definizione \ref{def:differenziazione_tangenti}.
