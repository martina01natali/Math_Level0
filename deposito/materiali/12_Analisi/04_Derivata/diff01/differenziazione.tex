...
Dato che gli infinitesimi che vogliamo trascurare hanno origine già nel 
rapporto 
...
$dx \ne 0$?}\\
Sappiamo già che esiste il modo corretto: \emph{la funzione parte standard 
$\pst{}$, 
...
al grafico e le stesse derivate rispetto a $x$.\\
 ...
 come funzione inversa l'inversione della formula $y=\dots$, come ad esempio $x=\frac{y}{k}$. Per questo la derivata viene calcolata rispetto a $y$: $x'=\pst{\dfrac{dx}{dy}}$.\\
...
$\frac{dy}{dx}$,  e $dx$ dipende da $dy$ nel rapporto inverso. Questo comporta questioni delicate, simili a quelle descritte a proposito del teorema \ref{teo:diff01_dericomp}. Per questo bisogna essere precisi nell'enunciato.
\end{osservazione}
\begin{esempio}
...
o 
razionale positivo o negativo, irrazionale ...), allora il teorema vale per qualsiasi esponente.
\end{proof}
...
derivata quindi non può esistere nei punti corrispondenti, come dimostra il grafico.
...
$v_{AB}|_{t=4}=\dfrac{ds_{AB}}{dt}=\dfrac{800(4t-2)}{2\sqrt{2t^2-2t+4}}
\bigg|_{t=4}\cong 907$ km/h.
\end{esempio}
...
$i(t)=\dfrac{dq(t)}{dt}=3t^2-24=0\srarrow t=\sqrt{8}\cong 2,8$ s.\\
