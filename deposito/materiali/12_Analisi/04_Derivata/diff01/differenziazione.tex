...
l'ingrandimento non è sufficiente per cogliere $dx=\epsilon$, che è 
infinitesimo di ordine superiore, quindi è troppo piccolo.
Se poi applichiamo un secondo microscopio che visualizza $dx$, allora $df(x)$
assume lunghezza infinita e non può essere valutato.
\end{minipage}
\end{center}
\end{inaccessibleblock}
\label{}
