...
\begin{minipage}{.48 \textwidth}
 \begin{center}
% \spaziovelocitacaduta
Il grafico consente di visualizzare la legge oraria del 
moto di caduta libera sotto due aspetti diversi: il ramo di parabola mostra che 
progressivamente lo spazio percorso è sempre maggiore. La retta mostra 
infatti che la progressione della velocità è lineare: man mano che il tempo 
...
l'accelerazione costante, minore è la velocità che si sviluppa. La pendenza del 
...
\(\frac{\Delta T}{\Delta h}\), il rapporto che calcola le pendenze, è il 
...
\[
 RI=\frac{\Delta f(x_0)}{\Delta x}= \frac{f(x_0+\Delta x)-f(x_0)}{(x_0+\Delta 
x)- x_0}.
\]
\end{definizione}
...
%grafico temperature smussato
    \subsubsection{GRAFICO TEMPERATURE SMUSSATO}
...
\(x_0+\epsilon\).
\[
 RI=\frac{\Delta f(x_0)}{dx}= \frac{f(x_0+\epsilon)-f(x_0)}{(x_0+\epsilon)- 
x_0}.
\]
\end{definizione}
...
\[
 ...
 \frac{\cancel{\epsilon}\tonda{2,5 + \frac{\epsilon}{4}}}{\cancel{\epsilon}}=
...
un'altra. Ora invece abbiamo un certo grado di incertezza, perché la pendenza 
risulta un numero finito iperreale, la somma di uno standard e di 
un infinitesimo. Si tratta di un numero non completamente esprimibile in 
cifre, perché la sua parte infinitesima non ha un valore sconosciuto.
Per fortuna, però, la sua parte infinitesima è trascurabile e si può 
ragionevolmente concludere che, anche considerando gli infiniti possibili 
valori dell'infinitesimo \(\frac{\epsilon}{4}\), tuttavia il risultato è 
...
non nullo \(\epsilon\), calcoliamo la su parte standard.
\[
