...
numeri indistinguibili, cioè le loro differenze non si possono cogliere 
perché
...
piano 
cartesiano reale. Nel piano iperreale, puntando l'infinito con un 
telescopio,
...
$x=0$.
 ...
 $(0;\ \frac{1}{0})$. Il punto è comunque visibile nel piano iperreale, con 
un
 telescopio.
 \end{esempio}
\begin{esempio}
...
condizione 
di carattere locale}, cioè per punti. Infatti si possono riconoscere dei 
punti
...
Se cerchiamo $dh(x)=dh$, incremento infinitesimo di altezza, siamo 
costretti 
a calcolare
...
gnomone infinitesimo $d\mathit{A}$, escluso il rettangolo destro 
infinitesimo,
di area $h\cdot db$.
Dunque:
\begin{align*}
 ...
 \dfrac{d\mathit{A}(x) \cdot b(x)-\mathit{A}(x) \cdot db(x)} 
{\tonda{b(x)}^2}
\end{align*}
\end{proof}
