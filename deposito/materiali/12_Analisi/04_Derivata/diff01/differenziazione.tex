...
\subsection{Derivata e tangente}
 ...
 dove  $\punto{x_0}{y_0}$ è il punto di tangenza, da conoscere preventivamente, 
...
\begin{esempio}
  ...
  Soluzione. Nel punto $V$: $f'(0)=2\cdot 0=0$. $m=0$, la tangente è orizzontale:
  $y=m(x-x_0)+y_0= 0$, coincide con l'asse $X$.\\
  Nel punto $B$: $f'(-6)=2\cdot (-6)=-12$. $m=-12$, la tangente è inclinata
  verso il basso:
  $y=m(x-x_0)+y_0= -12(x-6)+36=-12x+108$.
 \end{esempio}
...
\begin{esempio}
  ...
  \begin{osservazione}
   ...
   Qualsiasi retta tangente al grafico stacca sugli assi coordinati segmenti
   il cui punto medio coincide con quello di tangenza. Non è difficile
   dimostrarlo usando l'equazione generica $yx=k^2$ e per punto di tangenza
   le coordinate $\punto{a}{\dfrac{k^2}{a}}$.
  \end{osservazione}
...
La tangente è quindi una retta orizzontale. Di conseguenza la secante è verticale
