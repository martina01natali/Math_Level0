...
\item Il Rapporto Incrementale (R.I) fra le coppie di valori di una funzione 
è 
...
\begin{esempio}
Fissiamo su curva una due punti: uno fisso: $A$ e l'altro mobile, cioè in 
grado di 
spostarsi lungo la curva dalla posizione più lontana $H$, alla più prossima 
ad $A$,
...
\begin{figure}[h]
\begin{inaccessibleblock}[Tangente a una curva.]
 \begin{center}
\tangentecurva
 \end{center}
\end{inaccessibleblock}
\caption{Tangente ad una curva.} \label{fig:diff01_tangente}
\end{figure}
