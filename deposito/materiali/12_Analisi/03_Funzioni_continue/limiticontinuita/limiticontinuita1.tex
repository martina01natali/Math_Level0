...
\begin{itemize} [nosep]
 ...
 \item Se una funzione è continua in un punto, allora il limite per $x$ che 
tende a quel punto è uguale al valore che la funzione ha in quel punto.
\end{itemize}

Faccio un tentativo: se la \(f(x)\) è definita in $-2$ allora il limite è 
esattamente \(f(-2)\). Sostituiamo $x$ con $-2$:
\[\lim_{x \rightarrow -2} \frac{x^3+3x^2+2x}{x^2-x-6} \longrightarrow 
  \frac{\tonda{-2}^3+3\tonda{-2}^2+2\tonda{-2}}{\tonda{-2}^2-\tonda{-2}-6}=
  \frac{-8+12-4}{4+2-6}=\frac{0}{0}
\]

È evidente che \(f(-2)\) non è definita. È altrettanto evidente che $-2$ è 
uno zero sia del numeratore sia del denominatore quindi, per il teorema di 
Ruffini, entrambi questi polinomi sono divisibili per \(x+2\).
...
\lim_{x \rightarrow -2} \frac{x^2+x}{x-3}=\\ 
  &=\pst{\frac{\tonda{-2+\epsilon}\tonda{\tonda{-2+\epsilon}+1}}
              {\tonda{-2+\epsilon}-3}} \stackrel{2}{=} 
    \pst{\frac{-2\tonda{-2+1}}{-2+-3}} = 
    \pst{\frac{2}{-5}} = -\frac{2}{5}
\end{align*}
Dove le uguaglianze hanno i seguenti motivi:
\begin{enumerate} [nosep]
