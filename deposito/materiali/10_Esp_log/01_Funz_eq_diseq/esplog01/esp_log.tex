...
Nelle espressioni che seguono facciamo uso delle solite conoscenze, che 
ricordiamo:
\begin{itemize}[nosep]
 \item $M, \ N$ sono iperreali infiniti;
 \item $\epsilon, \ \delta$ sono iperreali infinitesimi;
 \item $a, \ k \in \IR$ sono numeri standard, cioè corrispondono a numeri 
reali;
...
finito $x$, permette di conoscere quale reale $r$ corrisponda a $x$; 
 \item un iperreale finito $x$ è formato da un reale $r=\pst{x}$ e da un 
infinitesimo $\delta$: \(x~=~\pst{x}~+~\delta~=~r~+~\delta\). \\
\end{itemize}
