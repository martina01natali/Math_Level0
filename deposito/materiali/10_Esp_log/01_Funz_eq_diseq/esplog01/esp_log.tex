...
%  \item Nel grafico precedente ho evidenziato dei punti che dovrebbero 
aiutare 
...
nome scelto per onorare il matematico svizzero 
Leonhard Euler, noto in Italia come Eulero 
(Basilea, 15 aprile 1707 – San Pietroburgo, 18 settembre 
1783).\footnote{vedi: \href{it.wikipedia.org/wiki/Eulero}
{it.wikipedia.org/wiki/Eulero}.}
\vspace{3em}
\end{minipage}
\hfill
...
\hfill
\begin{minipage}{.47\textwidth}
Ad esempio, dato che quando \(f(2)=e^2 \approx 7,389\), l'area sottesa alla 
funzione, da \(-\infty\) a \(2\) vale: \(e^2 \approx 7,389\)
\vspace{5em}
\end{minipage}
\end{minipage}
...
Per quanto abbiamo detto precedentemente, essendo \(a\) positiva, anche 
\(b\) 
dovrà essere un numero positivo perché nessuna potenza con base positiva 
può 
...
restituisce il valore dell'esponente, conoscendo la base e il valore della 
potenza. 
...
che 
permette di evitare il calcolo del logaritmo. Il metodo nasce dalla 
