...
quali avremo accumulato \(1,5\)~\officialeuro: li reinvestiamo subito e li
...
che corrisponde a \(2,25\)~\officialeuro. Sembra promettente, forse possiamo 
puntare a ottenere \(3\)~\officialeuro . Invece di ritirare e depositare di 
nuovo ogni 6 mesi, 
...
invece di \(2,25\)~\officialeuro, maturiamo un capitale di 4~\officialeuro 
già al termine del primo anno! Purtroppo però con questa banca il 
reinvestimento compulsivo non appare il metodo ideale.

In sintesi, i risultati con una banca o con l'altra, sono compresi fra il \(2\) 
e il \(4\) e progressivamente si assestano fra il \(2,71\) e il \(2,72\).
\end{minipage}
\hfill
\begin{minipage}{.49\textwidth}
\begin{center}
...
3 & 2,37037 & 3,375 \\
4 & 2,44141 & 3,1604938 \\
6 & 2,5216264 & 2,9859840 \\
10 & 2,56,57845 & 2,9102854\\
12 &  2,5937425 &  2,8679720 \\
100 &  2,7048138 &  2,7319990 \\
1000 &  2,7169239 &  2,7196422 \\
10\,000 &  2,7181459 &  2,7184178 \\
100\,000 &  2,7182682 &  2,7182954 \\
1\,000\,000 &  2,7182805 &  2,7182832 \\
10\,000\,000 &  2,7182817 &  2,7182820 \\
100\,000\,000 &  2,718281798 &  2,718281859 \\
\end{tabular}
\begin{center}Approssimazioni per \(e\)\end{center}
\label{tab:e}
\end{center}
\end{minipage}\\
...
La prima successione converge molto lentamente: come si vede nella  
tabella di pag.~\pageref{tab:e},  per poter ottenere otto cifre significative 
esatte bisogna porre 
\(n = 10\,000\,000\)!
