...
\(\ln\tonda{5x +7} = \ln\tonda{9x +15}\) \\[4pt]
\(\sistema{5x +7 >0 & \quad
             \text{(Condizione d'esistenza del \(1^\circ\) logaritmo)}\\ 
           9x +15 > 0 & \quad 
             \text{(Condizione d'esistenza del \(2^\circ\) logaritmo)}\\
           5x +7 = 9x +15 & \quad
             \text{(Equazione ottenuta eliminando i logaritmi)}}\) \\[4pt]
\(\sistema{x > -\dfrac{7}{5} \\[6pt] 
           x > -\dfrac{5}{3} \\[6pt] 
           5x - 9x = +15 -7} \quad \Longrightarrow \quad
  \sistema{x > -\dfrac{7}{5} \\[6pt] 
           x > -\dfrac{5}{3} \\[6pt] 
           x = -2}  \quad 
  \Longrightarrow \quad
  \sistema{x > -\dfrac{7}{5} \\[6pt] x = -2}\) \\[4pt]
L'ultimo passaggio è giustificato dal fatto che, se un numero è più grande 
di \(-\dfrac{7}{5} \approx -1,4\) 
sarà senz'altro più grande anche di~\(-\dfrac{5}{3} \approx -1,67\).
Ma ora questo sistema non ha soluzioni, perché se \(x=-2\), di certo 
non è più grande di \(-\dfrac{7}{5}\).
\end{esempio}
