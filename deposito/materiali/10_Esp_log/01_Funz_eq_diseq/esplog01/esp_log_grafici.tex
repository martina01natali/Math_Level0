...
\newcommand{\puntib}{% 
    ...
    \foreach \pi in {
    (-1, 0.5), (0, 1), (1, 2), (-0.75,0.5946), (-0.25,0.8409), (-0.5, 0.7071), (0.5, 1.41421),
...
\newcommand{\graficoesponenziale}{% 
    ...
    \tkzFct[domain=-5:4, ultra thick, color=Maroon!50!black]{2**x}
    }
}
...
\newcommand{\pendenzae}{% 
    % Esponenziali con basi diverse.
    \disegno{
    \rcom{-5}{+5}{-5}{10}{gray!50, very thin, step=1}
    \tkzInit[xmin=-5.3,xmax=+5.3,ymin=-5.3,ymax=+10.3]
    \tkzFct[domain=-5.3:+3, ultra thick, color=Maroon!50!black]{exp(x)}
...
\newcommand{\simmetriayx}{% 
  ...
  \filldraw [Maroon!50!black] \pi circle (2pt) node [below left] {\n};
...
\newcommand{\graficologaritmica}{% 
    ...
    \tkzFct[domain=0:+8.3, ultra thick, color=Maroon!50!black]{log(x)/log(2)}
    }
}
