...
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig014_corr_talete.pgf}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
	\centering\input{\folder lbr/fig015_teo_corr_talete.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig016_teo_corr_talete2.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig017_conseg_talete.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig018_conseg_talete2.pgf}
\end{minipage}
