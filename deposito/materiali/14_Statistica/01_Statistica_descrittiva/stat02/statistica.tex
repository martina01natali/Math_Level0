...
\input{\folder statistica_grafici.tex}
...
\scalebox{.8}{\input{\folder lbr/fig002_graf.pgf}}
\caption{Valori interi}
% \caption{Esempio~\ref{es:statistica2}}
\label{gr:A.1}
\end{minipage}\hfill
\begin{minipage}{0.5\textwidth}
\scalebox{.8}{\input{\folder lbr/fig003_graf.pgf}}
\caption{Valori intermedi}
% \caption{Esempio~\ref{es:statistica2}}
\label{gr:A.2}
\end{minipage}
\end{grafico}
...
\scalebox{.8}{\input{\folder lbr/fig008_dia.pgf}}
\caption{Diagramma a barre}
\end{inaccessibleblock}
\end{minipage} 
\begin{minipage}{.5\textwidth}
\begin{inaccessibleblock}[Figura: TODO]
 \scalebox{.8}{\input{\folder lbr/fig009_dia.pgf}}
...
%  \input{\folder lbr/fig010_areo.pgf}
 \scalebox{.7}{\input{\folder lbr/fig010_areo.pgf}}  
\end{center}
\end{minipage}
 \end{esempio}
% \end{exrig}
...
\begin{tabular}{lcc}
\toprule
Diametro (\(\unit{km}\)) & Numero  & 
Densità di Freq.\\
\midrule
\(0-50\) & 1088 & \(1088/50=21,76\) \\
\(50-100\) & 745 \(745/50=14,9\) \\
\(100-150\) & 20 \(20/50=0,4\) \\
\bottomrule
\end{tabular}
\end{center}
}{
\begin{inaccessibleblock}[Figura: istogramma]
\begin{center}\scalebox{.9}{\input{\folder lbr/fig011_dia.pgf}}\end{center}
\end{inaccessibleblock}
}
...
% \begin{inaccessibleblock}[Figura: TODO]
% \scalebox{.7}{\input{\folder lbr/fig011_dia.pgf}}
% \end{inaccessibleblock}
% \end{minipage}
% \end{center}
...
\begin{center}
\areoese
% \scalebox{.8}{\input{\folder lbr/fig011_areo.pgf}}
\end{center}
...
% di coppie/punti che si considerano, resta solo da deciderne i parametri. 
% A tale proposito, un valido criterio guida consiste nel ritenere che 
% \textquotedblleft la migliore retta sia quella che rende minima la somma 
% delle differenze al quadrato tra i valori di \(y_i\) realmente osservati 
% e i corrispondenti valori che la retta stessa fornisce per i diversi 
% valori di \(x_i\) osservati (\(i=1,2,3,\dots n\)); essendo \(n\) il numero 
% di punti che si considerano.
...
\[m=\frac{\sigma_{zy}}{\sigma^2_{y}}=\frac{-7,71}{97,80 }=-0,0788
  \quad \text{ e } \quad
q = \overline{y} - m \overline{z} = 21,30 + 0,0788 \cdot 172,38 = 34,88\]
da cui:
\[Z = -0,0788 \cdot Y + 34,88\]
...
=-0,0788 \cdot 160 + 34,88 = 22,27\). Questo se il modello della retta 
