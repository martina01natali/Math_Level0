...
% otteniamo:~\(b^2 = 2 \cdot k^2\). Da questo discende che anche~\(b^2\) è 
pari 
% e 
...
% scritti come frazione. Molte radici e alcuni numeri particolari come 
\(\pi\), 
...
% L'unione degli insiemi \(\Q\) e \(\insJ\) è l'insieme \(\insR\) dei 
numeri 
% reali.
...
dato.
In simboli~\(\sqrt a=b \Leftrightarrow b^2=a\) dove \(a,b\in \insR^{+} \cup 
\{0\}\).
\end{definizione}
...
Osserviamo che se l'indice è pari, non possiamo portare sotto radice 
fattori negativi.
...
%  \item \(3\cdot \sqrt{\dfrac 2{21}}=\sqrt{3^2\cdot \dfrac 2{21}}=
%         \sqrt{9\cdot \dfrac 2{21}}=\sqrt{\dfrac 6 7}\)
...
% \paragraph{II° modo:} 
Si può trasformare la potenza del radicando nel 
