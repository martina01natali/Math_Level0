...
radicando;
 ...
 \item \(\sqrt{30\cdot 27\cdot 10}\): scomponendo in fattori primi otteniamo 
  \[\sqrt{30\cdot 27\cdot 10}=
    ...
    \(\sqrt{2^2\cdot 3^4\cdot 5^2}=2\cdot 3^2\cdot 5=90\)
\end{itemize}
\end{esempio}
\end{exrig}

Se il radicando è un'espressione letterale, che non sappiamo quindi se sia 
positiva o negativa, dobbiamo scrivere
...
% \vspazio\ovalbox{\risolvii \ref{ese:2.21}, \ref{ese:2.22}, \ref{ese:2.23}, 
\ref{ese:2.24},\ref{ese:2.25},\ref{ese:2.26},\ref{ese:2.27},\ref{ese:2.28},\
ref{ese:2.29},\ref{ese:2.30},\ref{ese:2.31}}
...
\begin{itemize}
\item \(\sqrt 2\cdot \sqrt[3]2=\sqrt[6]{2^3}\cdot \sqrt[6]{2^2}=
       \sqrt[6]{2^3\cdot 2^2}=\sqrt[6]{2^5}\). 
 Gli indici delle radici sono \(2\) e \(3\), il loro~\(\mcm\) è~\(6\), 
 il primo radicando va elevato a~\(6:2\) cioè~\(3\), 
 mentre il secondo radicando va elevato a~\(6:3\) cioè~\(2\)
\item \(\sqrt[3]{\frac 3 2}\cdot \sqrt[4]{\frac 8{27}}: \sqrt[6]{\frac 2 3}=
       \sqrt[12]{\frac{3^4}{2^4}\cdot \frac{8^3}{27^3}:\frac{2^2}{3^2}}=
       \sqrt[12]{\frac{3^4}{2^4}\cdot \frac{2^9}{3^9}:\frac{2^2}{3^2}}=
       \sqrt[12]{\frac{3^6\cdot 2^9}{3^9\cdot 2^6}}=
       \sqrt[12]{\frac{2^3}{3^3}}=\sqrt[4]{\frac 2 3}\). 
 Il~\(mcm\) tra gli indici delle radici è \(12\). 
 Il primo radicando va elevato a \(12:3=4\) 
 il secondo radicando va elevato a \(12:4=3\) il terzo va elevato a 
\(12:6=2\).
\end{itemize}
 \end{esempio}

\begin{esempio}
 \(\dfrac{\sqrt[3]{x^2y}\cdot \sqrt{xy}}{\sqrt[6]{x^2y^3}},\, \CE x>0\wedge 
y>0\).
...
2\), 
 ...
 positivo (ovviamente per \(a\neq 1\)) è sufficiente che sia \(a+2\geqslant 
0\) 
 ovvero \(a\geqslant -2\). 
...
assoluto 
 perché sotto radice poteva essere sia negativo che positivo, la radice 
invece 
 deve essere sempre positiva; se \(a<0\) la relazione~\(\sqrt{2a^2}=a\sqrt 2\) 
è 
 errata;
...
con 
 resto uguale a \(2\) per \(b^7\) si ha \(7:3\) con quoziente~\(2\) e 
resto~\(1\) 
...
radice è dispari;
 ...
 \item\(\sqrt[4]{4x^4-4x^5}\) 
  ...
  \[\sqrt[4]{4x^4-4x^5}=\sqrt[4]{4x^4(1-x)} \CE 1-x\ge 0\Rightarrow \ x\le 
1.\]
  Pertanto:
...
\end{itemize}
 \end{esempio}
\end{exrig}
% \vspazio\ovalbox{\risolvii \ref{ese:2.42}, \ref{ese:2.43}, \ref{ese:2.44}, 
\ref{ese:2.45}}
