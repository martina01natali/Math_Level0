...
% \hfill [\(\left(11 x + 4\right)^{2}\)]
% \item \(16 x^{2} - 88 x + 121=\) 
% \hfill [\(\left(4 x - 11\right)^{2}\)]
% \item \(100 x^{2} - 140 x + 49=\) 
% \hfill [\(\left(10 x - 7\right)^{2}\)]
% \item \(100 x^{2} + 80 x + 16=\) 
% \hfill [\(4 \left(5 x + 2\right)^{2}\)]
% \item \(121 x^{2} - 154 x + 49=\) 
% \hfill [\(\left(11 x - 7\right)^{2}\)]
% \item \(144 x^{2} - 120 x + 25=\) 
% \hfill [\(\left(12 x - 5\right)^{2}\)]
% \item \(121 x^{2} - 242 x + 121=\) 
% \hfill [\(121 \left(x - 1\right)^{2}\)]
% \item \(100 x^{2} - 220 x + 121=\) 
% \hfill [\(\left(10 x - 11\right)^{2}\)]
% \item \(100 x^{2} + 100 x + 25=\) 
% \hfill [\(25 \left(2 x + 1\right)^{2}\)]
% \item \(x^{2} - 12 x + 36=\) 
% \hfill [\(\left(x - 6\right)^{2}\)]
...
% \item \(\frac{9 x^{2}}{4} - \frac{21 x}{2} + \frac{49}{4}=\) \hfill 
% [\(\frac{\left(3 x - 7\right)^{2}}{4}\)]
% \item \(\frac{81 x^{2}}{121} - \frac{216 x}{11} + 144=\) \hfill 
% [\(\frac{9 \left(3 x - 44\right)^{2}}{121}\)]
% \item \(\frac{25 x^{2}}{9} + \frac{70 x}{9} + \frac{49}{9}=\) \hfill 
% [\(\frac{\left(5 x + 7\right)^{2}}{9}\)]
% \item \(\frac{25 x^{2}}{36} - \frac{25 x}{6} + \frac{25}{4}=\) \hfill 
% [\(\frac{25 \left(x - 3\right)^{2}}{36}\)]
% \item \(\frac{x^{2}}{64} + \frac{9 x}{20} + \frac{81}{25}=\) \hfill 
% [\(\frac{\left(5 x + 72\right)^{2}}{1600}\)]
% \item \(\frac{81 x^{2}}{4} - \frac{21 x}{2} + \frac{49}{36}=\) \hfill 
% [\(\frac{\left(27 x - 7\right)^{2}}{36}\)]
% \item \(\frac{64 x^{2}}{9} - \frac{16 x}{15} + \frac{1}{25}=\) \hfill 
% [\(\frac{\left(40 x - 3\right)^{2}}{225}\)]
% \item \(\frac{x^{2}}{144} + \frac{2 x}{5} + \frac{144}{25}=\) \hfill 
% [\(\frac{\left(5 x + 144\right)^{2}}{3600}\)]
% \item \(\frac{81 x^{2}}{121} - \frac{6 x}{11} + \frac{1}{9}=\) \hfill 
% [\(\frac{\left(27 x - 11\right)^{2}}{1089}\)]
% \item \(\frac{121 x^{2}}{25} - \frac{44 x}{45} + \frac{4}{81}=\) \hfill 
% [\(\frac{\left(99 x - 10\right)^{2}}{2025}\)]
% \item \(\frac{64 x^{2}}{49} - \frac{32 x}{35} + \frac{4}{25}=\) \hfill 
% [\(\frac{4 \left(20 x - 7\right)^{2}}{1225}\)]
% \item \(\frac{144 x^{2}}{49} + \frac{72 x}{35} + \frac{9}{25}=\) \hfill 
% [\(\frac{9 \left(20 x + 7\right)^{2}}{1225}\)]
% \item \(\frac{36 x^{2}}{25} + \frac{96 x}{55} + \frac{64}{121}=\) \hfill 
% [\(\frac{4 \left(33 x + 20\right)^{2}}{3025}\)]
% \item \(\frac{81 x^{2}}{25} + \frac{216 x}{35} + \frac{144}{49}=\) \hfill 
% [\(\frac{9 \left(21 x + 20\right)^{2}}{1225}\)]
% \item \(\frac{121 x^{2}}{100} - \frac{121 x}{35} + \frac{121}{49}=\) \hfill 
% [\(\frac{121 \left(7 x - 10\right)^{2}}{4900}\)]
\end{enumeratea}
\end{multicols}
\end{esercizio}
% 
...
% \item \(16 x^{2} - 121=\) 
% \hfill [\(\left(4 x - 11\right) \left(4 x + 11\right)\)]
% \item \(100 x^{2} - 81=\) 
% \hfill [\(\left(10 x - 9\right) \left(10 x + 9\right)\)]
% \item \(100 x^{2} - 81=\) 
% \hfill [\(\left(10 x - 9\right) \left(10 x + 9\right)\)]
% \item \(25 x^{2} - 121=\) 
% \hfill [\(\left(5 x - 11\right) \left(5 x + 11\right)\)]
% \item \(100 x^{2} - 49=\) 
% \hfill [\(\left(10 x - 7\right) \left(10 x + 7\right)\)]
% \item \(144 x^{2} - 100=\) 
% \hfill [\(4 \left(6 x - 5\right) \left(6 x + 5\right)\)]
% \item \(121 x^{2} - 100=\) 
% \hfill [\(\left(11 x - 10\right) \left(11 x + 10\right)\)]
% \item \(100 x^{2} - 121=\) 
% \hfill [\(\left(10 x - 11\right) \left(10 x + 11\right)\)]
...
% \item \(9 x^{2} - \frac{121}{49}=\) 
% \hfill [\(\frac{\left(21 x - 11\right) \left(21 x + 11\right)}{49}\)]
% \item \(\frac{x^{2}}{4} - \frac{16}{81}=\) 
% \hfill [\(\frac{\left(9 x - 8\right) \left(9 x + 8\right)}{324}\)]
% \item \(\frac{x^{2}}{16} - \frac{9}{100}=\) 
% \hfill [\(\frac{\left(5 x - 6\right) \left(5 x + 6\right)}{400}\)]
% \item \(\frac{4 x^{2}}{9} - \frac{4}{49}=\) 
% \hfill [\(\frac{4 \left(7 x - 3\right) \left(7 x + 3\right)}{441}\)]
% \item \(\frac{x^{2}}{4} - \frac{121}{49}=\) 
% \hfill [\(\frac{\left(7 x - 22\right) \left(7 x + 22\right)}{196}\)]
% \item \(\frac{9 x^{2}}{16} - \frac{1}{144}=\) 
% \hfill [\(\frac{\left(9 x - 1\right) \left(9 x + 1\right)}{144}\)]
% \item \(\frac{16 x^{2}}{81} - \frac{9}{4}=\) 
% \hfill [\(\frac{\left(8 x - 27\right) \left(8 x + 27\right)}{324}\)]
% \item \(\frac{9 x^{2}}{121} - \frac{1}{4}=\) 
% \hfill [\(\frac{\left(6 x - 11\right) \left(6 x + 11\right)}{484}\)]
% \item \(\frac{64 x^{2}}{121} - \frac{81}{4}=\) 
% \hfill [\(\frac{\left(16 x - 99\right) \left(16 x + 99\right)}{484}\)]
% \item \(\frac{4 x^{2}}{25} - \frac{36}{49}=\) 
% \hfill [\(\frac{4 \left(7 x - 15\right) \left(7 x + 15\right)}{1225}\)]
% \item \(\frac{25 x^{2}}{16} - \frac{144}{49}=\) 
% \hfill [\(\frac{\left(35 x - 48\right) \left(35 x + 48\right)}{784}\)]
% \item \(\frac{16 x^{2}}{49} - \frac{121}{16}=\) 
% \hfill [\(\frac{\left(16 x - 77\right) \left(16 x + 77\right)}{784}\)]
% \item \(\frac{16 x^{2}}{25} - \frac{49}{81}=\) 
% \hfill [\(\frac{\left(36 x - 35\right) \left(36 x + 35\right)}{2025}\)]
% \item \(\frac{144 x^{2}}{25} - \frac{25}{64}=\) 
% \hfill [\(\frac{\left(96 x - 25\right) \left(96 x + 25\right)}{1600}\)]
% \item \(\frac{100 x^{2}}{81} - \frac{121}{64}=\) 
% \hfill [\(\frac{\left(80 x - 99\right) \left(80 x + 99\right)}{5184}\)]
% \item \(\frac{64 x^{2}}{121} - \frac{121}{16}=\) 
% \hfill [\(\frac{\left(32 x - 121\right) \left(32 x + 121\right)}{1936}\)]
% \item \(\frac{16 x^{2}}{121} - \frac{121}{64}=\) 
% \hfill [\(\frac{\left(32 x - 121\right) \left(32 x + 121\right)}{7744}\)]
\end{enumeratea}
\end{multicols}
\end{esercizio}
...
% \item \(x^{2} + 7 x + 12=\) 
% \hfill [\(\left(x + 3\right) \left(x + 4\right)\)]
% \item \(x^{2} + 4 x - 21=\) 
% \hfill [\(\left(x - 3\right) \left(x + 7\right)\)]
% \item \(x^{2} + 8 x - 48=\) 
% \hfill [\(\left(x - 4\right) \left(x + 12\right)\)]
% \item \(x^{2} - 6 x - 72=\) 
% \hfill [\(\left(x - 12\right) \left(x + 6\right)\)]
% \item \(x^{2} - 6 x - 72=\) 
% \hfill [\(\left(x - 12\right) \left(x + 6\right)\)]
% \item \(x^{2} - 5 x - 50=\) 
% \hfill [\(\left(x - 10\right) \left(x + 5\right)\)]
% \item \(x^{2} - 6 x - 40=\) 
% \hfill [\(\left(x - 10\right) \left(x + 4\right)\)]
% \item \(x^{2} + 12 x + 11=\) 
% \hfill [\(\left(x + 1\right) \left(x + 11\right)\)]
% \item \(x^{2} + 10 x - 11=\) 
% \hfill [\(\left(x - 1\right) \left(x + 11\right)\)]
% \item \(x^{2} - 12 x + 11=\) 
% \hfill [\(\left(x - 11\right) \left(x - 1\right)\)]
% \item \(x^{2} - 21 x + 108=\) 
% \hfill [\(\left(x - 12\right) \left(x - 9\right)\)]
% \item \(x^{2} - 23 x + 132=\) 
% \hfill [\(\left(x - 12\right) \left(x - 11\right)\)]
...
% \item \(x^{2} + \frac{x}{3} - \frac{7}{48}=\) 
% \hfill [\(\frac{\left(4 x - 1\right) \left(12 x + 7\right)}{48}\)]
% \item \(x^{2} - \frac{94 x}{9} + \frac{40}{9}=\) 
% \hfill [\(\frac{\left(x - 10\right) \left(9 x - 4\right)}{9}\)]
% \item \(x^{2} - \frac{5 x}{8} + \frac{1}{16}=\) 
% \hfill [\(\frac{\left(2 x - 1\right) \left(8 x - 1\right)}{16}\)]
% \item \(x^{2} + \frac{14 x}{9} + \frac{8}{27}=\) 
% \hfill [\(\frac{\left(3 x + 4\right) \left(9 x + 2\right)}{27}\)]
% \item \(x^{2} - \frac{67 x}{24} + \frac{1}{3}=\) 
% \hfill [\(\frac{\left(3 x - 8\right) \left(8 x - 1\right)}{24}\)]
% \item \(x^{2} + \frac{16 x}{15} + \frac{4}{15}=\) 
% \hfill [\(\frac{\left(3 x + 2\right) \left(5 x + 2\right)}{15}\)]
% \item \(x^{2} + \frac{68 x}{11} + \frac{12}{11}=\) 
% \hfill [\(\frac{\left(x + 6\right) \left(11 x + 2\right)}{11}\)]
% \item \(x^{2} - \frac{32 x}{33} - \frac{16}{33}=\) 
% \hfill [\(\frac{\left(3 x - 4\right) \left(11 x + 4\right)}{33}\)]
% \item \(x^{2} - \frac{13 x}{24} - \frac{21}{32}=\) 
% \hfill [\(\frac{\left(8 x - 9\right) \left(12 x + 7\right)}{96}\)]
% \item \(x^{2} - \frac{87 x}{22} + \frac{35}{22}=\) 
% \hfill [\(\frac{\left(2 x - 7\right) \left(11 x - 5\right)}{22}\)]
% \item \(x^{2} - \frac{17 x}{24} - \frac{11}{12}=\) 
% \hfill [\(\frac{\left(3 x + 2\right) \left(8 x - 11\right)}{24}\)]
% \item \(x^{2} + \frac{31 x}{60} + \frac{1}{24}=\) 
% \hfill [\(\frac{\left(10 x + 1\right) \left(12 x + 5\right)}{120}\)]
% \item \(x^{2} + \frac{125 x}{77} + \frac{50}{77}=\) 
% \hfill [\(\frac{\left(7 x + 5\right) \left(11 x + 10\right)}{77}\)]
% \item \(x^{2} - \frac{111 x}{110} - \frac{1}{10}=\) 
% \hfill [\(\frac{\left(10 x - 11\right) \left(11 x + 1\right)}{110}\)]
% \item \(x^{2} + \frac{140 x}{33} + \frac{100}{33}=\) 
% \hfill [\(\frac{\left(3 x + 10\right) \left(11 x + 10\right)}{33}\)]
\end{enumeratea}
\end{multicols}
\end{esercizio}
...
%  \item 
% \(\left(\dfrac{3}{4}a^{2}b^{3}c^{2}-\dfrac{1}{3}a^{2}{bc}^{2}\right)^{3}\)
...
% \hfill [\(27 \left(x - 2\right)^{3}\)]
% \item \(- 64 x^{3} - 96 x^{2} - 48 x - 8=\) 
% \hfill [\(- 8 \left(2 x + 1\right)^{3}\)]
% \item \(- 27 x^{3} + 81 x^{2} - 81 x + 27=\) 
% \hfill [\(- 27 \left(x - 1\right)^{3}\)]
% \item \(- 8 x^{3} + 72 x^{2} - 216 x + 216=\) 
% \hfill [\(- 8 \left(x - 3\right)^{3}\)]
% \item \(- 216 x^{3} - 216 x^{2} - 72 x - 8=\) 
% \hfill [\(- 8 \left(3 x + 1\right)^{3}\)]
% \item \(- 64 x^{3} + 240 x^{2} - 300 x + 125=\) 
% \hfill [\(- \left(4 x - 5\right)^{3}\)]
% \item \(- 27 x^{3} + 135 x^{2} - 225 x + 125=\) 
% \hfill [\(- \left(3 x - 5\right)^{3}\)]
% \item \(- 27 x^{3} + 162 x^{2} - 324 x + 216=\) 
% \hfill [\(- 27 \left(x - 2\right)^{3}\)]
...
% \item \(\frac{27 x^{3}}{125} - \frac{27 x^{2}}{5} + 45 x - 125=\) 
% \hfill [\(\frac{\left(3 x - 25\right)^{3}}{125}\)]
% \item \(\frac{27 x^{3}}{8} + \frac{27 x^{2}}{4} + \frac{9 x}{2} + 1=\) 
% \hfill [\(\frac{\left(3 x + 2\right)^{3}}{8}\)]
% \item \(- x^{3} - \frac{9 x^{2}}{2} - \frac{27 x}{4} - \frac{27}{8}=\) 
% \hfill [\(- \frac{\left(2 x + 3\right)^{3}}{8}\)]
% \item \(x^{3} - \frac{18 x^{2}}{5} + \frac{108 x}{25} - \frac{216}{125}=\) 
% \hfill [\(\frac{\left(5 x - 6\right)^{3}}{125}\)]
% \item \(125 x^{3} - \frac{75 x^{2}}{4} + \frac{15 x}{16} - \frac{1}{64}=\) 
% \hfill [\(\frac{\left(20 x - 1\right)^{3}}{64}\)]
% \item \(- x^{3} - \frac{12 x^{2}}{5} - \frac{48 x}{25} - \frac{64}{125}=\) 
% \hfill [\(- \frac{\left(5 x + 4\right)^{3}}{125}\)]
% \item \(\frac{27 x^{3}}{8} - \frac{9 x^{2}}{4} + \frac{x}{2} - \frac{1}{27}=\) 
% \hfill [\(\frac{\left(9 x - 2\right)^{3}}{216}\)]
% \item \(- \frac{64 x^{3}}{125} - \frac{96 x^{2}}{25} - \frac{48 x}{5} - 8=\) 
% \hfill [\(- \frac{8 \left(2 x + 5\right)^{3}}{125}\)]
% \item \(- \frac{x^{3}}{27} + \frac{x^{2}}{18} - \frac{x}{36} + \frac{1}{216}=\) 
% \hfill [\(- \frac{\left(2 x - 1\right)^{3}}{216}\)]
% \item \(- \frac{x^{3}}{216} + \frac{x^{2}}{48} - \frac{x}{32} + \frac{1}{64}=\) 
% \hfill [\(- \frac{\left(2 x - 3\right)^{3}}{1728}\)]
% \item \(\frac{x^{3}}{8} + \frac{9 x^{2}}{20} + \frac{27 x}{50} + 
% \frac{27}{125}=\) 
% \hfill [\(\frac{\left(5 x + 6\right)^{3}}{1000}\)]
% \item \(- \frac{x^{3}}{8} - \frac{3 x^{2}}{10} - \frac{6 x}{25} - 
% \frac{8}{125}=\) 
% \hfill [\(- \frac{\left(5 x + 4\right)^{3}}{1000}\)]
% \item \(\frac{x^{3}}{125} - \frac{12 x^{2}}{125} + \frac{48 x}{125} - 
% \frac{64}{125}=\) 
% \hfill [\(\frac{\left(x - 4\right)^{3}}{125}\)]
% \item \(- \frac{8 x^{3}}{27} + \frac{10 x^{2}}{3} - \frac{25 x}{2} + 
% \frac{125}{8}=\) 
% \hfill [\(- \frac{\left(4 x - 15\right)^{3}}{216}\)]
% \item \(- \frac{8 x^{3}}{27} + \frac{8 x^{2}}{5} - \frac{72 x}{25} + 
% \frac{216}{125}=\) 
% \hfill [\(- \frac{8 \left(5 x - 9\right)^{3}}{3375}\)]
% \item \(- \frac{8 x^{3}}{125} + \frac{36 x^{2}}{125} - \frac{54 x}{125} + 
% \frac{27}{125}=\) 
% \hfill [\(- \frac{\left(2 x - 3\right)^{3}}{125}\)]
\end{enumeratea}
\end{multicols}
\end{esercizio}
