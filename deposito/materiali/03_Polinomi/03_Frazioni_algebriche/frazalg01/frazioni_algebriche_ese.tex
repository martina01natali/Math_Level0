...
%   \hfill $\left[2(x-2y);\,12x(x-2y)^3\right]$
...
%   \hfill $\left[\frac{a+b+1}{(a-1)(b+1)}\right]$
%  \item $\dfrac{1}{2a+1}+\dfrac{1}{a-1}+\dfrac{1}{2a^{2}-a-1}$
%   \hfill $\left[\frac{3a+1}{2a^{2}-a-1}\right]$
...
%  \item $\dfrac{x^{2}}{2}-\dfrac{(1-x)^{2}}{x^{3}-x}-\dfrac{2}{1-x}+(x-3)\cdot 
%        {\dfrac{2x-x^{2}-1}{(1-x^{2})^{2}}}$
%   \hfill $\left[\frac{x^{6}+x^{5}-x^{4}-x^{3}+18x^{2}-2}
%                      {2x(x-1)(x+1)^{2}}\right]$
%  \item $\left(\dfrac{1}{a^{2}-2a+1}+\dfrac{1}{a^{2}-3a+2}\right):
%         \dfrac{4a^{2}-6a}{1-a}$
%   \hfill $\left[\frac{-1}{2a(a-1)(a-2)}\right]$
%  \item $\left(\dfrac{x}{x-a}-\dfrac{x}{x-1}\right)
%         \dfrac{ax^{2}-ax-a^{2}x+a^{2}}{ax-x^{2}}$
%   \hfill $\left[\frac{a(a-1)}{a-x}\right]$
\end{enumeratea}
\end{esercizio}
...
%   \hfill $\left[\frac{(x-2)^{2}(2x^{2}+3x+2)}{8x^{5}}\right]$
%  \item $\left(\dfrac{a-1}{a+4}-\dfrac{a+1}{a-4}\right):\left(\dfrac{a-1}{4-a}+
...
%   \hfill $\left[\frac{2x+3}{3(x-2)(x-1)}\right]$
% \end{enumeratea}
% \end{esercizio}
