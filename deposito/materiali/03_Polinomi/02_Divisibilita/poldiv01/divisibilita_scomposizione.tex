...
Per eseguire l'operazione tra polinomi si usa un algoritmo molto simile a 
quello usato per la divisione tra numeri interi. 
...
\begin{center} \scalebox{.8}{\divpola} \end{center}
}
...
\begin{center} \scalebox{.8}{\divpolb} \end{center}
}
\item ~
...
\begin{center} \scalebox{.8}{\divpolc} \end{center}
}
\item ~
...
\begin{center} \scalebox{.8}{\divpold} \end{center}
}
\item ~
...
\begin{center} \scalebox{.8}{\divpole} \end{center}
}
\item ~
...
\begin{center} \scalebox{.8}{\divpolf} \end{center}
}
...
\vspace*{1.3em}
\begin{center} \scalebox{.8}{\divpolg} \end{center}
}
\end{enumerate*}
...
% \begin{exrig}
 \begin{esempio}
Eseguire la seguente divisione: \quad 
...
due;
 \item \(\ushortw{bx} -\ushortw{2ab}+\ushortdw{2ax}-
        \ushortdw{4a^{2}}=
        b(\ushortw{x-2a})+2a(\ushortw{x-2a})=(x-2a)(b+2a)\).
 \end{enumeratea}
 \end{esempio}
...
Scomporre in fattori~\(bx^3+x^2-bx-1+abx+a\).
 \begin{enumeratea}
  \item Raggruppiamo nel seguente modo:~
   \(\ushortw{bx^3}+\ushortdw{x^2}-\ushortw{bx}-
     \ushortdw{1}+\ushortw{abx}+\ushortdw{a}\) 
   tra quelli con sottolineatura semplice metto a fattore comune~\(bx\), 
   negli altri raccogliamo~\(1\)
  \item
   \(\ushortw{bx^3}+\ushortdw{x^2}-\ushortw{bx}-
    \ushortdw{1}+\ushortw{abx}+\ushortdw{a}=
    bx\bigl(\ushortw{x^2-1+a}\bigr)+1\bigl(\ushortw{x^2-1+a}\bigr)=
...
Scomporre in fattori~\(5ab^{2}-10abc-25abx+50acx\).
 \begin{enumeratea}
  ...
  \item vediamo se è possibile scomporre il polinomio in parentesi con un 
   raccoglimento parziale~\(5a(\ushortw{b^{2}}-\ushortw{2bc}
     -\ushortdw{5bx}+\ushortdw{10cx})=
     5a\bigl[b(\ushortw{b-2c})-5x(\ushortw{b-2c})\bigr]=5a(b-2c)(b-5x)\).
 \end{enumeratea}
 \end{esempio}
% \end{exrig}
...
\ushortw{2x^2-2x}~\ushortw{-x+1}=
2x \cdot \ushortw{\tonda{x-1}}-1 \cdot \ushortw{\tonda{x-1}}=
...
\(\tonda{\ushortw{{x+y}}}^{2}-2\cdot\tonda{\ushortw{{x+y}}}\),
