...
\input{\folder pianocartesiano_grafici.tex}
...
\begin{esempio}
 \label{ex:D.12}
  Determiniamo l'immagine delle coppie 
ordinate~\((2;3)\),~\((-1;4)\),~\((-3;-2)\), 
  e~\((4;-3)\).
...
\begin{esempio}
 \label{ex:D.13}
  ...
  sull'asse~\(x\) coincide con~\(O\), quindi la coppia~\((0;~4)\) sarà 
associata al 
  punto~\(R\) dell'asse~\(y\) 
  e la coppia~\((0;~-2)\) al punto~\(S\) dello stesso asse. 
  Analogamente le coppie~\((-4;~0)\) e~\((3;~0)\) sono associate 
rispettivamente 
