...
\newcommand{\fascparall}{% 
  \rcom{-5}{+5}{-6}{+6}{gray!50, very thin, step=1}
  \tkzInit[xmin=-5.3,xmax=+5.3,ymin=-6.3,ymax=+6.3]
  \tkzFct[domain=-5.3:+5.3, ultra thick, color=green!50!black]{-3./4*x+3}
...
\newcommand{\fascioparall}{% soluzione esempio fascio con retta parallela
  \disegno[4]{
    \fascparall
    \foreach \px in {-4, 0, +4}
      \filldraw [red!50!black] (\px, -3./4*\px+3) circle (1.5pt);
...
\newcommand{\distpuntorettaa}{% Distanza punto - retta
  \disegno[4]{
