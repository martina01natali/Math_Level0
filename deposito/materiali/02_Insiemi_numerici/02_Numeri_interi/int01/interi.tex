...
\begin{wrapfloat}{figure}{r}{0pt}
 \input{\folder lbr/fig001_everest.pgf}
...
\begin{center}
 \input{\folder lbr/fig002_rettainteri.pgf}
\end{center}
...
Per indicare che un numero è maggiore di un altro si usa separare i due 
numeri 
con il
...
Questo significa che se si addizionano, si sottraggono o si moltiplicano 
due 
...
Osserviamo prima di tutto che il simbolo di addizione~\((+)\) è lo stesso 
che si 
...
Almeno all'inizio è bene usare una scrittura del tipo~\((+2)+(+5)\) per 
indicare 
...
rappresenta il primo addendo.
 \[(-3)+(+5)=2\]
\begin{center}
 \input{\folder lbr/fig004_somma1.pgf}
\end{center}
\[ (-1)+(-3) = -4\]
\begin{center}
 \input{\folder lbr/fig005_somma2.pgf}
\end{center}
...
\begin{wrapfloat}{figure}{r}{0pt}
\input{\folder lbr/fig007_molsegni.pgf}
\end{wrapfloat}
...
% 
% Un'operazione gode della proprietà associativa se presi tre numeri si 
% ottiene 
% sempre
...
% 
% Dovendo moltiplicare tre o più numeri relativi si può procedere 
% scegliendo % a 
...
% (-2)=(+15)\cdot (-2)=(-30)\).
% Oppure si può cominciare dalla seconda moltiplicazione~\((-3)\cdot 
% [(-5)\cdot 
% (-2)]=(-3)\cdot (+10)=(-30)\).
% 
...
% 
% Un'operazione su uno specifico insieme numerico ha elemento neutro se 
% esiste, 
% ed è unico, un numero che composto
% con un qualsiasi altro numero lo lascia inalterato.
% 
% Nella somma algebrica l'elemento neutro è~0 sia che si trovi a destra sia 
% che 
% si trovi a sinistra dell'operazione:
% \[+3+0=+3,\qquad -2+0=-2,\qquad~0+5=+5,\qquad~0-4=-4. \]
% 
% Nella moltiplicazione l'elemento neutro è~\(+1\) sia a destra sia a 
% sinistra:
% \[-5\cdot (+1) =-5,\qquad +3\cdot (+1) = +3,\qquad +1\cdot (-3) = 
% -3,\qquad 
% +1\cdot (+7) = +7.\]
% 
...
% 
% Dividendo~\(+1\) per un numero intero relativo si ottiene un numero 
% intero % solo 
% se il divisore è~\(+1\) o~\(-1\).
% 
% \subsection{Proprietà distributiva della moltiplicazione rispetto 
% all'addizione}
% Moltiplicare il risultato dell'addizione di più numeri per un altro 
% numero % dà 
% lo stesso risultato
