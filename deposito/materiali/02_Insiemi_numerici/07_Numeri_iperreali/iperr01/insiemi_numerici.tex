...
Se accettiamo che possa non valere il postulato di Eudosso-Archimede, 
possiamo costruire un insieme numerico non archimedeo. 
...
numeri che non sono infiniti né infinitesimi.
\end{description}
...
Gli Iperreali finiti sono quei numeri che sono compresi tra due numeri 
Reali:
...
Ogni numero finito può essere visto come un numero \emph{reale} 
...
\begin{itemize}
 ...
 \item \(\epsilon\) è un iperreale infinitesimo.
\end{itemize}

Se \(x=a+\epsilon\) allora potremmo dire che \(x\) è infinitamente vicino 
ad \(a\) infatti sottraendo ad entrambi i membri dell'uguaglianza la 
stessa quantità \(a\) otteniamo: 
...
iperreali di una nuvola vicina, appartenenti per esempio al numero 
iperreale $y=b+\delta$. 
...
ad ogni numero reale corrisponde un punto della retta e ad ogni 
