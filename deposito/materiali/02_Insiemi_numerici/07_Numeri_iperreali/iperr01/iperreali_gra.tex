...
\newcommand{\secRD}{% 
  ...
  \begin{scope}[ultra thick, color=Maroon!50!black]
    \tkzInit[xmin=-2.3,xmax=+10.3,ymin=-8.3,ymax=+12.3]
    \tkzFct{0.5*x**2-4*x+10} 
    \tkzFct[thick, color=Cyan!50!black] {2*x-8}  
  \end{scope}
  \filldraw [color=Black] (6, 4) circle (2pt) node [below right] {\(T\)};
  \microscopio{(6, 4)}{2}{30}{200}{3}{(1.8, 1.2)}{\(\times \infty\)}
