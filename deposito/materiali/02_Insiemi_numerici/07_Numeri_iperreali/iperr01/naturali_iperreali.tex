...
\affiancati{.49}{.49}{
Se si riesce a trovare un numero \(s\) tale che \(\frac{s}{n}\) 
dell'unità di misura siano equivalenti alla grandezza, allora prendiamo 
\(\frac{s}{n}\) come misura della grandezza \(l\).
}{
...
prendiamo \(\frac{s}{n}\) come misura della grandezza \(l\).
}
...
Ad esempio in questi poligoni regolari, l'altezza e le diagonali sono 
...
\affiancati{.49}{.49}{
Se decidiamo che ci sia uno solo nuovo numero per ciascuna sezione, otteniamo 
una grandissima quantità di numeri che sono infinitamente di più rispetto a 
tutti i problemi che che possiamo pensare di esprimere.
}{
...
In questo caso, la distanza tra questi dovrà essere minore di 
...
Se ce ne sono almeno due, allora ce ne sono infiniti, perché anche la media 
