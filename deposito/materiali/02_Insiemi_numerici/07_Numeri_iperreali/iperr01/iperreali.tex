...
abbandonarne, per ora, il postulato di Eudosso-Archimede. 
...
\begin{enumerate} [nosep]
 \item \(\pst{-a} = -\pst{a}\)
 \item \(\pst{a \mp b} = \pst{a} \mp \pst{b}\)
 \item \(\pst{ab} = \pst{a} \cdot \pst{b}\)
 \item \(se ~ \pst{b} \neq 0 ~ allora ~
 \pst{\frac{a}{b}} = \frac{\pst{a}}{\pst{b}}\)
 \item \(se ~  a \leqslant b ~ allora ~ 
 \pst{a} \leqslant \pst{b}\)
\end{enumerate}
\end{multicols}
