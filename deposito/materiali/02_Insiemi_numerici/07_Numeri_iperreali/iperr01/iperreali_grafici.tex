...
\newcommand{\microscopiob}{% Microscopio per vedere -3,000002.
    ...
    \draw (-1.75, 5.5) [left] node [rotate=90] {-3,000000};
    }
}
...
\newcommand{\iperparabolaetangente}[4]{% 
...
%   \def \punto{(6, 4)} % Perchè non riesco a usarlo?
  \disegno[4]{
  \iperparabolaetangente{0.5*x**2-4*x+10}{2*x-8}{(6, 4)}{below right}
...
%   \def \punto{(2, 3)} % Perchè non riesco a usarlo?
  \disegno[4]{
  \iperparabolaetangente{0.25*x**2-2*x+6}{-x+5}{(2, 3)}{below left}
