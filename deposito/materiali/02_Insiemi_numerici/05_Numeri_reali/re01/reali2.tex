...
moltiplicazione, la divisione (ad eccezione della divisione per 0), la 
potenza. 
Non sempre, invece, è possibile eseguire l'estrazione di radice. Per esempio, 
hai già conosciuto il numero \(\sqrt{2}\), cioè il numero che elevato al 
quadrato 
...
il punto~\(K\), ma ancora non abbiamo trovato un numero razionale che sia 
uguale 
a~\(\sqrt{2}\).
