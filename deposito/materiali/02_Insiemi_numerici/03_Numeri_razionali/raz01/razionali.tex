...
\ref{ese:3.32}, \ref{ese:3.33}, \ref{ese:3.34}, \ref{ese:3.35}, \ref{ese:3.36}, 
...
21\(\cdot\dfrac{5}{3}=\) \officialeuro\ 35.
 ...
 \begin{esempio}
Giuseppe possiede \officialeuro\ 150. Se spende i~\(3/5\) della somma posseduta 
e 
...
\[\frac{2}{3}=0,\overline{6}=\frac{0,\overline{6}}{1}=\frac{66,\overline{6}}{100
}=66,
\overline{6}\%.\]
...
\[A: B = C: D,\]
che si legge \emph{\(A\) sta a~\(B\) come~\(C\) sta a~\(D\)}, con~\(B\) e~\(D\) 
diversi da 
zero.
\end{definizione}
