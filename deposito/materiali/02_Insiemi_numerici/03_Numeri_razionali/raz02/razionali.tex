...
del capitolo sui numeri naturali: \(1523:7\).
Ma questa volta aggiungiamo, a destra del numero un po' di zeri separati 
dal numero con la virgola decimale: \(1523,000:7\)

Questa volta presento lo stesso algoritmo ma un po' abbreviato: il 
risultato della moltiplicazione viene tolto al volo dal dividendo e viene 
scritto direttamente il nuovo resto. La filastrocca di questa divisione è 
la seguente:
...
L'impressione è che questo ``algoritmo'' non termini mai. Ed è vero!

Proviamo con un altro caso:
...
resto~0, oppure andare avanti all'infinito. Ma siamo sicuri che la prima 
...
\begin{esempio}
 ...
 \begin{enumerate} [noitemsep]
  \item \(\dfrac{4}{12} - \dfrac{5}{15} = \dfrac{1}{3} - \dfrac{1}{3} = 0\)
    \hfill \(60 = 4 \cdot 15 = 5 \cdot 12 = 60\)
  \item \(-\dfrac{TODO}{7} -\dfrac{15}{7}\)
    \hfill \(-12 > -15\)
  \item \(\dfrac{TODO}{5} + \dfrac{6}{10}\)
    \hfill \(5 < 10\)
  \item \(\dfrac{TODO}{8} + \dfrac{5}{4}\)
    \hfill \(\dfrac{7}{8} < \dfrac{10}{8} = \dfrac{5}{4}\)
 \end{enumerate}
\end{esempio}
