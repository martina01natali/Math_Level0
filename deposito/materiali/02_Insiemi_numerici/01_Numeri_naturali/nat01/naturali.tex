...
\grafoscatolasx{add}{\(o_1\)}{\(o_2\)}{somma}\\[0.5em]
\grafoscatoladx{add}{\(o_1\)}{\(o_2\)}{somma}\\[0.5em]
\end{inaccessibleblock}

\begin{inaccessibleblock}
[Descrizione immagine: Funzione rappresentata come porta logica]
\grafoporta{add}{\(o_1\)}{\(o_2\)}{somma}
\end{inaccessibleblock}
\end{center}
\end{minipage}
\hfill
...
\grafoscatolasx{add}{\(7\)}{\(5\)}{\(12\)}\\[0.5em]
\grafoscatoladx{add}{\(7\)}{\(5\)}{\(12\)}\\[0.5em]
\end{inaccessibleblock}
\begin{inaccessibleblock}
...
\end{lstlisting}
\begin{description} [noitemsep]
\item [\textbf{``print''}] è un comando per visualizzare qualcosa sullo schermo;
...
\grafoporta{sub}{\(o_1\)}{\(o_2\)}{differenza}
\end{inaccessibleblock}
\end{center}
\end{minipage}
\hfill
...
\grafoporta{mul}{\(o_1\)}{\(o_2\)}{prodotto}
\end{inaccessibleblock}
\end{center}
\end{minipage}
\hfill
...
\grafoporta{div}{\(o_1\)}{\(o_2\)}{quoziente}
\end{inaccessibleblock}
\end{center}
\end{minipage}
\hfill
...
\grafoporta{pow}{\(o_1\)}{\(o_2\)}{potenza}
\end{inaccessibleblock}
\end{center}
\end{minipage}
\hfill
...
%\begin{align*}
% a^m:a^n &=\underbrace{(a\cdot  a\cdot a \cdot\ldots\cdot a)}_{m\text{ volte}}:
% \underbrace{(a\cdot a \cdot \ldots \cdot a)}_{n \text{ volte}}\\
% &=\underbrace{(a:a)\cdot(a:a)\cdot\ldots \cdot(a:a)}_{m \text{ volte}} \cdot%
