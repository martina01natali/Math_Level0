...
% \label{ese:1.14}
 ...
 \fcharbox{A}~368 \quad \fcharbox{B}~\((3+5)^5\) \quad 
\fcharbox{C}~\(15+15\) \quad \fcharbox{D}~\(8^8\)
 \end{esercizio}

\begin{esercizio}
% \label{ese:1.15}
 Il risultato di~\((73+27)^2\) è: \quad \quad
 \fcharbox{A}~200 \quad\fcharbox{B}~\(73^2+27^2\) 
\quad\fcharbox{C}~\(10^4\) \quad\fcharbox{D}~\(1000\)
\end{esercizio}
...
\newcommand{\numeriboxati}{
\fbox{2} \quad \fbox{3} \quad \fbox{4} \quad \fbox{5} \quad \fbox{6}
\quad \fbox{7} \quad \fbox{8} \quad \fbox{9} \quad \fbox{10} \quad
\fbox{11}}
...
possibile vederle di nuovo tutte e
...
%   \{[20^5:(10\cdot2)^3-10^2]:(3\cdot5^2)\}\)\hfill[20]
% \end{esercizio}
% \begin{esercizio} % \label{ese:1.17}
...
%   \{[20^5:(2\cdot10)^3-10^2]:^10^2+1\}+1\)\hfill[20]
% \end{esercizio}
\begin{esercizio} % \label{ese:1.17}
...
%   11-5 \cdot 2^2]-3^2\}:(7\cdot5)-18\)\hfill[0]
% \end{esercizio}
...
% \begin{esercizio}[*]
% % \label{ese:1.43}
% Un'automobile percorre~18{\unit km} con~1 litro di benzina. 
...
% intraprendere un viaggio di~432{\unit km} e che deve
...
% Se alla gita partecipano~132~studenti,
% quanti insegnanti occorrono?
% \end{esercizio}
% 
% \begin{esercizio}
% % \label{ese:1.48}
% Un palazzo è costituito da~4~piani con~2~appartamenti per ogni piano. 
% Se ogni appartamento ha~6~finestre con~4~vetri ciascuna, 
