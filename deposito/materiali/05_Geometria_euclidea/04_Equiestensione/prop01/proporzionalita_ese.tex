...
è la più grande\hfill\boxV\quad\boxF
\item Due grandezze geometriche si dicono commensurabili quando 
esiste una terza grandezza che è sottomultipla comune alle altre due 
\tab\hfill{\boxV\quad\boxF}
\item Un qualunque numero razionale può essere definito come elemento 
separatore di due classi numeriche contigue\hfill\boxV\quad\boxF
\item La misura di un segmento è un segmento\hfill\boxV\quad\boxF
\item la diagonale di un quadrato è incommensurabile con il 
lato\hfill\boxV\quad\boxF
\end{enumeratea}
\end{esercizio}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig035_esercizio.pgf}
...
\begin{esercizio}
\label{ese:6.29}
La somma di due segmenti misura 12~cm, determina le loro misure 
sapendo che
\begin{enumeratea}
\item uno è il doppio dell'altro;
\item uno è il triplo dell'altro;
...
\item \(\beta=\frac{1}{2}\alpha\) e \(\alpha\) e \(\beta\) sono 
complementari.
\end{enumeratea}
\end{esercizio}
...
\begin{esercizio}
\label{ese:6.31}
Determina, per ogni parte della figura~\ref{fig:ese6.31}, la misura 
mancante, indicata con un punto interrogativo.
\end{esercizio}


\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig036_esercizio.pgf}
...
\begin{esercizio}
\label{ese:6.32}
Con riferimento alla figura a fianco, quali proporzioni sono 
...
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig037_esercizio.pgf}
\end{minipage}\vspace{4pt}

\noindent\begin{minipage}{0.6\textwidth}\parindent15pt
\begin{esercizio}
\label{ese:6.33}
Nella figura a fianco c'è un triangolo e una delle sue bisettrici. 
Quali proporzioni sono conseguenza del teorema della bisettrice?
\begin{enumeratea}
\item \(a : b = x : y\)
\item \(a : m = m : b\)
\item \(x : m = m : y\)
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig038_esercizio.pgf}
\end{minipage}

\noindent\begin{minipage}{0.6\textwidth}\parindent15pt
\begin{esercizio}
\label{ese:6.34}
Sapendo che le rette \(r\), \(s\), \(t\) e \(u\) della figura a fianco sono 
parallele, completa le proporzioni
\begin{enumeratea}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
	\centering\input{\folder lbr/fig039_esercizio.pgf}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig040_esercizio.pgf}
...
\begin{esercizio}
\label{ese:6.53}
\`E vero che due poligoni regolari aventi lo stesso numero di lati 
...
cui diagonale sia doppia della diagonale \(MP\). \`E vero che 
\(M’N’P’Q’\sim MNPQ\)? Qual è il rapporto di similitudine? Costruisci 
il quadrato \(M''N''P''Q''\) avente diagonale metà di \(MP\). \`E vero 
che \(M''N''P''Q''\sim MNPQ\)? Qual è il rapporto di similitudine? \`E 
...
ad \(AB\) e \(A'B'\), vale la stessa proporzione? \`E possibile 
...
\np{7,62}~cm e \np{5,83}~cm. Indicato con \(K\) il punto di 
...
\np{4,57}~cm e \np{5,94}~cm. Prolungandoli si ottiene un triangolo che 
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig041_esercizio.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig042_esercizio.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig043_esercizio.pgf}
...
\begin{esercizio}
\label{ese:6.92}
A che distanza dal vertice \(A\) di un triangolo deve essere posto un 
punto \(P\) sul lato \(AB\) di 12~cm, in modo che la parallela condotta 
da \(P\) al lato \(BC\) determini un triangolo \(APR\) che sia i \(9/16\) del 
trapezio \(PRCB\)?
\end{esercizio}
...
\begin{esercizio}[Olimpiadi della Matematica - Gara di II livello, 
febbraio 2012]
\label{ese:6.96}
...
\end{enumeratea}
(Nota: la similitudine tra \(DAA'\) e \(ABC\) va intesa in modo ordinato: 
\(DA : AB = AA':BC=A'D:CA\))
\end{esercizio}
...
\begin{esercizio}
\label{ese:6.99}
Nella figura~\ref{fig:ese6.99}, applicando il teorema delle corde, 
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig044_esercizio.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig045_esercizio.pgf}
...
Il rettangolo dell'esercizio~\ref{ese:6.108} viene chiamato 
...
\centering\includegraphics[width=0.57\textwidth]{\folder img/partenone.png}
\qquad\includegraphics[width=0.24\textwidth]{\folder img/monna_lisa.png}
\end{figure*}
...
\begin{minipage}{0.3\textwidth}
	\centering\input{\folder lbr/fig046_esercizio.pgf}
\end{minipage}
