...
\begin{inaccessibleblock}[Figura: TODO]
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig040_esercizio.pgf}}
\end{center}
%  \begin{figure}[!htb]
...
% del trapezio?
% \hfill\(\quadra{h_1=4~m,\quad h_2=14~m,\quad d=\np{7,2}~m}\)
% \end{esercizio}
% 
% \begin{esercizio}
% \label{ese:6.88}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig041_esercizio.pgf} \end{center}
\end{inaccessibleblock}
\end{minipage}
...
\begin{minipage}{.5\textwidth}
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig042_esercizio.pgf} \end{center}
\end{inaccessibleblock}
\end{minipage}
...
\begin{minipage}{.5\textwidth}
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig043_esercizio.pgf} \end{center}
\end{inaccessibleblock}
\end{minipage}
...
\begin{minipage}{.5\textwidth}
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig044_esercizio.pgf} \end{center}
\end{inaccessibleblock}
\end{minipage}
...
\begin{minipage}{.6\textwidth}
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig045_esercizio.pgf} \end{center}
\end{inaccessibleblock}
\end{minipage}
...
% febbraio 2007]
% \label{ese:6.106}
% È data una circonferenza di diametro \(AB\) e centro \(O\). Sia \(C\) un 
