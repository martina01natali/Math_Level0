...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig001_mult_segmento.pgf}
\end{figure*}
...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig002_diag_quadrato.pgf}
\end{figure*}
...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig003_classif_numeri.pgf}
\end{figure*}
...
lbr/fig004_classi_rettangoli.pgf}	
\end{figure*}
...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig005_talete_gen.pgf}	
\end{figure*}
...
\begin{figure*}[!htb]
	\centering\input{\folder 
lbr/fig006_talete_gen_coroll1.pgf}	
\end{figure*}
...
\begin{figure*}[!htb]
	\centering\input{\folder 
lbr/fig007_talete_gen_coroll2.pgf}	
\end{figure*}
...
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig008_teo_bisettrice.pgf}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig009_prop_segm.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig010_quarto_prop.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.45\textwidth}
	\centering\input{\folder lbr/fig011_prop_div_retta.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.37\textwidth}
	\centering\input{\folder lbr/fig012_stessa_forma.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.55\textwidth}
	\centering\input{\folder lbr/fig013_pol_simili.pgf}
\end{wrapfigure}
...
\label{sect:similitudine_triangoli}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig014_tri_simili1.pgf}
\hspace{2cm}\input{\folder lbr/fig015_tri_simili11.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder lbr/fig014_tri_simili1.pgf}
% \hspace{2cm}\input{\folder lbr/fig015_tri_simili11.pgf}
% \end{figure*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig016_tri_simili2.pgf}
\hspace{2cm}\input{\folder lbr/fig017_tri_simili21.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder 
% lbr/fig016_tri_simili2.pgf}\hspace{2cm}\input{\folder 
% lbr/fig017_tri_simili21.pgf}
% \end{figure*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig018_tri_simili3.pgf}
\hspace{2cm}\input{\folder lbr/fig019_tri_simili31.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder 
% lbr/fig018_tri_simili3.pgf}\hspace{2cm}\input{\folder 
% lbr/fig019_tri_simili31.pgf}
% \end{figure*}
...
\begin{minipage}{0.65\textwidth}
	\centering\input{\folder lbr/fig020_tri_simili_alt.pgf}
\end{minipage}\vspace{5pt}
\noindent\begin{minipage}{0.35\textwidth}\parindent15pt
\item al rapporto tra le rispettive mediane;
\end{minipage}\hfil
\begin{minipage}{0.65\textwidth}
	\centering\input{\folder lbr/fig021_tri_simili_med.pgf}
\end{minipage}\vspace{5pt}
\noindent\begin{minipage}{0.35\textwidth}\parindent15pt
\item al rapporto tra le bisettrici uscenti da due vertici omologhi.
\end{minipage}\hfil
\begin{minipage}{0.65\textwidth}
	\centering\input{\folder lbr/fig022_tri_simili_bis.pgf}
\end{minipage}\vspace{5pt}
\end{itemize*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig023_tri_simili_2p.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder lbr/fig023_tri_simili_2p.pgf}
% \end{figure*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig024_tri_simili_area.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder lbr/fig024_tri_simili_area.pgf}
% \end{figure*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig025_fig_simili_decomp.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder lbr/fig025_fig_simili_decomp.pgf}
% \end{figure*}
...
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig026_pol_reg_sim_apo.pgf}}
\end{center}

% \begin{figure*}[!htb]
% 	\centering\input{\folder lbr/fig026_pol_reg_sim_apo.pgf}
% \end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig027_teo_corde.pgf}
\end{minipage}\vspace{5pt}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig028_teo_secanti.pgf}
\end{minipage}\vspace{5pt}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig029_teo_tan_secante.pgf}
\end{minipage}\vspace{5pt}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig030_sez_aurea.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
	\centering\input{\folder lbr/fig031_sez_aurea2.pgf}
...
\begin{figure*}[!htb]
	\begin{center}
		\begin{minipage}{0.45\textwidth}
			\centering
			\input{\folder lbr/fig032_dec_reg.pgf}
		\end{minipage}
		\hspace{0.03\textwidth}	
		\begin{minipage}{0.45\textwidth}
			\centering
			\input{\folder lbr/fig033_dec_reg2.pgf}
		\end{minipage}
	\end{center}
\end{figure*}
...
\begin{wrapfigure}{r}{0.35\textwidth}
	\centering\input{\folder lbr/fig034_sin_18.pgf}
\end{wrapfigure}
