...
\centering\input{\folder lbr/fig007_parallelogrammi_equiv1.pgf}
\end{minipage}
...
\centering\input{\folder lbr/fig008_parallelogrammi_equiv2.pgf}
\end{minipage}
\noindent\begin{minipage}{0.65\textwidth}\parindent15pt
...
\centering\input{\folder lbr/fig009_parallelogrammi_equiv3.pgf}
\end{minipage}
\end{proof}
...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig018_pol_reg_equiv_tri.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig019_pol_conv_lato.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig020_pol_conv_lato2.pgf}
\end{wrapfigure}
\paragraph{Pentagono.}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering\input{\folder lbr/fig021_tri_equiv.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.55\textwidth}
	\centering\input{\folder lbr/fig022_pol_conc.pgf}
\end{wrapfigure}
...
\centering\input{\folder lbr/fig023_quad_equiv_pol.pgf}\vspace{6pt}\\
	
\centering\input{\folder lbr/fig024_quad_equiv_pol2.pgf}\vspace{6pt}
\\
	\centering\input{\folder lbr/fig025_quad_equiv_pol_es.pgf}
\end{wrapfigure}
...
\centering\input{\folder lbr/fig032_secondo_teo_Euclide_inv.pgf}
\end{figure*}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{\folder lbr/fig039_tri_equi_inscr.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\centering\input{\folder lbr/fig040_tri_equi_circ.pgf}
\end{wrapfigure}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
	\centering\input{\folder lbr/fig041_trap_circos.pgf}
\end{figure}
\end{inaccessibleblock}
...
\input{\folder lbr/fig042_trap_rett_circos.pgf}
...
\caption{Esempio~\ref{es:7.8}}\label{fig:es7.8}
		...
		\begin{minipage}{0.45\textwidth}
			\centering
			\input{\folder lbr/fig043_trap_circos2.pgf}
...
\begin{figure*}[!htb]
	\centering\input{\folder lbr/fig044_trap_circos_semi.pgf}
\end{figure*}
...
\end{minipage}\hfil
\begin{minipage}{0.35\textwidth}
	\centering\input{\folder lbr/fig045_trap_circos_semi2.pgf}
\end{minipage}\vspace{8pt}
...
\setlength{\intextsep}{3pt plus 2.0pt minus 2.0pt}
\begin{wrapfigure}{r}{0.3\textwidth}
	\input{\folder lbr/fig046_tri_circos.pgf}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	\input{\folder lbr/fig047_tri_inscr.pgf}
\end{wrapfigure}
