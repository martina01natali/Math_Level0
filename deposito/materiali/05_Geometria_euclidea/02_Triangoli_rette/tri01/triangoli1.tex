...
\begin{center}
\begin{inaccessibleblock}[Figura: TODO]
\input{\folder lbr/fig006_esempio.pgf}
\end{inaccessibleblock}
\end{center}
...
% (vedi figura~\ref{fig:esempio2.2}). 
...
\begin{center}
\begin{inaccessibleblock}[Figura: TODO]
\input{\folder lbr/fig007_esempio.pgf}
\end{inaccessibleblock}
\end{center}
\end{proof}
\end{multicols}
...
\section{Teoremi del triangolo isoscele}
...
\begin{center}
\begin{inaccessibleblock}[Figura: TODO]
\input{\folder lbr/fig008_tri_isoscele_dir.pgf}
\end{inaccessibleblock}
\end{center}
\end{multicols}
\end{proof}
...
\begin{center}
\begin{inaccessibleblock}[Figura: TODO]
\input{\folder lbr/fig009_tri_isoscele_inv.pgf}
\end{inaccessibleblock}
\end{center}
\end{multicols}
