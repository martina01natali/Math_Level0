...
\subsection{Generalità sui quadrilateri}
...
\affiancati{.44}{.54}{
Nella figura a fianco sono rappresentati un quadrilatero concavo 
...
%   \begin{figure}[htb]
\centering \scalebox{.8}{\input{\folder lbr/fig002_quadrilateri.pgf}}
%   \end{figure}
...
\begin{inaccessibleblock}[Figura: TODO]
%   \begin{figure}[htb]
\centering \scalebox{.8}{\input{\folder lbr/fig003_trapezi.pgf}}
%   \end{figure}
\end{inaccessibleblock}
}
...
\affiancati{.49}{.49}{
Il teorema precedente è invertibile. 

Precisamente vale il teorema seguente:
}{
\begin{inaccessibleblock}[Figura: TODO]
%   \begin{figure}[htb]
...
\begin{inaccessibleblock}[Figura: TODO]
%   \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig012_diag_rettangolo.pgf}\end{center}
%   \end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
%   \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig013_diag_rombo.pgf}\end{center}
%   \end{figure}
\end{inaccessibleblock}
