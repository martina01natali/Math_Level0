...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig001_teo_ang_est.pgf}
\end{figure}
...
\centering\input{\folder lbr/fig002_teo_rette_perp.pgf}
\end{minipage}
~\\
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig003_rette_perp_per_punto.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig004_rette_perp_parall.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig005_rette_parall_1.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig006_rette_parall_2.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig007_teo_parall.pgf}
\end{figure}
\end{inaccessibleblock}
...
\centering\input{\folder lbr/fig008_crit_parall.pgf}
\end{minipage}
...
\centering\input{\folder lbr/fig009_teo_parall_inv.pgf}
\end{minipage}
~\\
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig010_ang_int_triang.pgf}
\end{figure}
\end{inaccessibleblock}
...
\centering\input{\folder lbr/fig011_ang_int_poly.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.5\textwidth}
\centering\input{\folder lbr/fig012_ang_est_poly.pgf}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig013_2crit_gen_cong_tri.pgf}
\end{figure}
\end{inaccessibleblock}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
\centering\input{\folder lbr/fig014_tri_isoscele_prop.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
\centering\input{\folder lbr/fig015_tri_isoscele_prop2.pgf}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig016_4crit_cong_tri.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig017_crit_part_cong_tri_rett.pgf}
\end{figure}
\end{inaccessibleblock}
...
\end{minipage}\hfil
\begin{minipage}{0.3\textwidth}
\centering\input{\folder lbr/fig018_tri_lato_angolo.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.3\textwidth}
\centering\input{\folder lbr/fig019_tri_angolo_lato.pgf}
\end{minipage}
~\\
...
\end{minipage}\hfil
\begin{minipage}{0.3\textwidth}
\centering\input{\folder lbr/fig020_tri_lati.pgf}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig021_tri_lati_angoli.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig022_tri_angoli_lati.pgf}
\end{figure}
\end{inaccessibleblock}
...
\centering\input{\folder lbr/fig023_poly_lati.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.4\textwidth}
\centering\input{\folder lbr/fig024_poly_inscritti.pgf}
\end{minipage}
...
\end{minipage}\hfil
\begin{minipage}{0.3\textwidth}
\centering\input{\folder lbr/fig025_esempio.pgf}
\end{minipage}
\end{esempio}
\end{exrig}
