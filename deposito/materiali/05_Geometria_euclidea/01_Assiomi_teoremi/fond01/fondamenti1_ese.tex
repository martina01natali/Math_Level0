...
\begin{inaccessibleblock}[Figura: TODO]
\begin{center}
\scalebox{1}{ \input{\folder lbr/fig074_ese.pgf}}
\end{center}
\end{inaccessibleblock}
...
\begin{center}
\begin{inaccessibleblock}[Figura: TODO]
\scalebox{1.0}{ \input{\folder lbr/fig075_ese.pgf}}
\end{inaccessibleblock}
\end{center}
...
\begin{esercizio}[Prove invalsi 2006]
\label{ese:1.130}
Scegli tra le figure riportate sotto, %nella figura~\ref{fig:ese1.130} 
quella 
