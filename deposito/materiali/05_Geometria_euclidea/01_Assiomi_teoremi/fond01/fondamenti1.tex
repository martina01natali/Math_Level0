...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering\input{\folder lbr/fig002_enti.pgf}
...
\centering\input{\folder lbr/fig003_euc.pgf}
\end{minipage}\hfil
...
\begin{inaccessibleblock}[Figura: TODO]
 ...
 \centering
 \input{\folder lbr/fig004_assioma2.pgf}
 \caption{Assioma II}\label{fig:1.3}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \centering
 \input{\folder lbr/fig005_assioma3.pgf}
 \caption{Assioma III}\label{fig:1.4}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \centering
 \input{\folder lbr/fig006_assioma4.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering
 \input{\folder lbr/fig007_assioma7.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 ...
 \centering
 \input{\folder lbr/fig008_assioma12.pgf}
 \caption{Assioma XII}\label{fig:1.7}
 \end{minipage}
 \begin{minipage}[b]{.5\textwidth}
 \centering
 \input{\folder lbr/fig009_assioma14.pgf}
...
\end{definizione}
\begin{figure*}[bth]
\centering  \input{\folder lbr/fig013_def_angolo.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig014_assioma15.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig015_assioma17.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[hbt]
 \centering \input{\folder lbr/fig016_tipi_rette.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[!htb]
  \centering\input{\folder lbr/fig020_fascio_proprio_rette.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig017_segmento.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig018_def11.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[tbh]
 \centering \input{\folder lbr/fig019_def12.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering\input{\folder lbr/fig021_def13.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig022_def14.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[bth]
 \centering \input{\folder lbr/fig023_angolo_piatto_e_giro.pgf}
...
\begin{figure*}[htb]
\centering  \input{\folder lbr/fig024_angolo.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering \input{\folder lbr/fig025_angolo.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering \input{\folder lbr/fig026_angoli_consecutivi.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering \input{\folder lbr/fig027_angoli_adiacenti.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
 \centering \input{\folder lbr/fig028_angoli_opposti_al_vertice.pgf}
...
\centering\input{\folder lbr/fig029_figure.pgf}
\input{\folder lbr/fig030_figure.pgf}
\end{inaccessibleblock}
\end{minipage}
\hfil
\begin{minipage}{.49 \textwidth}
...
\hfil
\begin{minipage}{.49 \textwidth}
\begin{inaccessibleblock}[Figure uguali e orientate nello stesso modo, figure 
congruenti ma ruotate una rispetto all'altra.]
\centering\input{\folder lbr/fig031_figure.pgf}
\input{\folder lbr/fig032_figure.pgf}
\end{inaccessibleblock}
\end{minipage}

\begin{minipage}{.49 \textwidth}
\begin{inaccessibleblock}[Due figure simmetriche rispetto ad una retta.]
\centering\input{\folder lbr/fig033_figure.pgf}\label{fig:figure_i_j}
\end{inaccessibleblock}
\end{minipage}
\hfil
\begin{minipage}{.49 \textwidth}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig034_cfr_segmenti.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig035_cfr_angoli.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig036_somma_segmenti.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig037_diff_segmenti.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig038_mult_segmento.pgf}
...
\begin{procedura}[Sottomultiplo di un segmento]\label{proc:fonda_sottomultiplo}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig039_sottomult_segmento.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig040_punto_medio.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig041_esempio1.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig042_somma_angoli.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig043_diff_angoli.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig044_mult_angolo.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig045_bisettrice.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig046_angolo_retto.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig047_angoli_complementari.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig048_angoli_supplementari.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig049_angoli_esplementari.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig050_ang_acuto_ottuso.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig051_cong_opposti_al_vertice.pgf}
\end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig052_perpendicolari.pgf}
...
%     \item 
%     Traccia la circonferenza di centro D e raggio ED, quindi la circonferenza 
...
%     \item 
%     Traccia la circonferenza di centro C e raggio CA, che interseca la retta 
% AB 
%     in A ed E. 
%     \item 
...
%     \item 
%     Traccia la retta CF, che è la perpendicolare alla retta AB, passante per 
% C.
%     \end{enumerate}
% \end{procedura}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig053_distanza_P_retta.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig054_asse_segmento.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig061_spezzata.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig062_spezzate.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig063_poligoni.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig064_angoli_poligoni.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig065_angoli_est.pgf}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\centering\input{\folder lbr/fig066_corda_diag.pgf}
