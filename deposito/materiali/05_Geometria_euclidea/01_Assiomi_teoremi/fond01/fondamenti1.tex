...
% Copyright (c) 2016 Maria Antonietta Pollini
% 
...
%  \begin{figure}[htb]
 \begin{center}\input{\folder lbr/fig002_enti.pgf}\end{center}
...
%\begin{center}
% \input{\folder lbr/fig002_enti.pgf}
%\end{center}
...
\begin{center}\input{\folder lbr/fig003_euc.pgf}\end{center}
\end{minipage}\hfil
...
%  \begin{figure}[bth]
 ...
 \begin{center} \input{\folder lbr/fig004_assioma2.pgf}\end{center}
%  \caption{Assioma II}\label{fig:1.3}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \begin{center} \input{\folder lbr/fig005_assioma3.pgf}\end{center}
%  \caption{Assioma III}\label{fig:1.4}
 \end{minipage}
 \begin{minipage}[b]{.32\textwidth}
 \begin{center} \input{\folder lbr/fig006_assioma4.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
 \begin{center} \input{\folder lbr/fig007_assioma7.pgf}\end{center}
...
\begin{center}
\input{\folder lbr/fig010_teo_dens_retta.pgf}
\end{center}
\begin{definizione}
...
\end{definizione}
\begin{center}
\input{\folder lbr/fig011_def1.pgf}
\end{center}
...
% (figura~\ref{fig:1.7}).
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig008_assioma12.pgf}\end{center}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{center} \input{\folder lbr/fig009_assioma14.pgf}\end{center}
\end{inaccessibleblock}
...
\begin{center}
 \input{\folder lbr/fig012_def_semiretta.pgf}
\end{center}
...
\end{definizione}
% \begin{figure*}[bth]
\begin{center}  \input{\folder lbr/fig013_def_angolo.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center} \input{\folder lbr/fig014_assioma15.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center} \input{\folder lbr/fig015_assioma17.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[hbt]
 \begin{center} \input{\folder lbr/fig016_tipi_rette.pgf}\end{center}
...
%  \begin{figure}[!htb]
  \begin{center}
   \input{\folder lbr/fig020_fascio_proprio_rette.pgf}
  \end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center} \input{\folder lbr/fig017_segmento.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center} \input{\folder lbr/fig018_def11.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[tbh]
 \begin{center} \input{\folder lbr/fig019_def12.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center}\input{\folder lbr/fig021_def13.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[bth]
 \begin{center} \input{\folder lbr/fig022_def14.pgf}\end{center}
...
%  \begin{figure}[bth]
 \begin{center} 
  \input{\folder lbr/fig023_angolo_piatto_e_giro.pgf}
 \end{center}
...
% \begin{figure*}[htb]
\begin{center}  \input{\folder lbr/fig024_angolo.pgf}\end{center}
...
\begin{minipage}{.39\textwidth}
 \begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
 \begin{center} \input{\folder lbr/fig025_angolo.pgf}\end{center}
...
%  \begin{figure}[htb]
 \begin{center} 
 \input{\folder lbr/fig026_angoli_consecutivi.pgf}
 \end{center}
...
%  \begin{figure}[htb]
 \begin{center} 
  \input{\folder lbr/fig027_angoli_adiacenti.pgf}
 \end{center}
...
%  \begin{figure}[htb]
 \begin{center} 
  \input{\folder lbr/fig028_angoli_opposti_al_vertice.pgf}
 \end{center}
...
\begin{minipage}{.49 \textwidth}
\begin{inaccessibleblock}[Due figure con la stessa forma ma diverse 
dimensioni e figure completamente diverse.]
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig029_figure.pgf}}
\scalebox{.8}{\input{\folder lbr/fig030_figure.pgf}}
\end{center}
\end{inaccessibleblock}
\end{minipage}
\hfil
...
\hfil
\begin{minipage}{.49 \textwidth}
\begin{inaccessibleblock}[Figure uguali e orientate nello stesso modo, 
figure 
congruenti ma ruotate una rispetto all'altra.]
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig031_figure.pgf}}
\scalebox{.8}{\input{\folder lbr/fig032_figure.pgf}}
\end{center}
\end{inaccessibleblock}
\end{minipage}

\begin{minipage}{.49 \textwidth}
\begin{inaccessibleblock}[Due figure simmetriche rispetto ad una retta.]
\begin{center}
\scalebox{.8}{\input{\folder lbr/fig033_figure.pgf}}
\end{center}
...
\begin{procedura}[Compasso rigido]\label{proc:fonda_comp_rig}
...
\lstinputlisting[firstline=2]{\folder src/12trasporto_seg.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig034_cfr_segmenti.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig035_cfr_angoli.pgf}\end{center}
...
\lstinputlisting[firstline=2]{\folder src/13trasporto_ang.py}
\fi
...
\begin{procedura}[Trasporto di un angolo]\label{proc:fonda_trasp_ang}
...
\begin{inaccessibleblock}[Figura: Somma di due segmenti. Il segmento $AD$ è 
la somma dei segmenti $AB$ e $CD$]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig036_somma_segmenti.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: Differenza di due segmenti. Il segmento 
$DB$ è la differenza dei segmenti $AB$ e $CD$]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig037_diff_segmenti.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: Multiplo di un segmento. Il segmento $AC$ 
è il multiplo secondo 3 di $AB$, cioè $AC\cong 3\cdot AB$]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig038_mult_segmento.pgf}\end{center}
% \captionMultiplo di un segmento. Il segmento $AC$ è il multiplo 
% secondo 3 di $AB$, cioè $AC\cong 3\cdot AB$gure}
\end{inaccessibleblock}
...
\begin{procedura}[Multiplo di un segmento]\label{proc:fonda_multiplo}
...
\lstinputlisting[firstline=2]{\folder src/14multiplo_seg.py}
\fi
...
\begin{procedura}[Retta parallela]\label{proc:fonda_parallela}
...
\lstinputlisting[firstline=2]{\folder src/15parallela.py}
\fi
...
\begin{procedura}[Sottomultiplo di un 
segmento]\label{proc:fonda_sottomultiplo}
...
\lstinputlisting[firstline=2]{\folder src/16sottomultiplo.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig039_sottomult_segmento.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: Punto medio di un segmento. $M$ è il 
punto medio del segmento $AB$ poiché $AM\cong MB$]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig040_punto_medio.pgf}\end{center}
...
\begin{procedura}[Punto medio]\label{proc:fonda_puntomedio}
...
\lstinputlisting[firstline=2]{\folder src/17puntomedio.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig041_esempio1.pgf}\end{center}
% \end{figure}
\end{inaccessibleblock}
...
\begin{inaccessibleblock}[Figura: Somma di due angoli.]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig042_somma_angoli.pgf}\end{center}
...
\begin{minipage}{.59\textwidth}
 \begin{inaccessibleblock}[Figura: Differenza di due angoli.]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig043_diff_angoli.pgf}\end{center}
...
\vspace{5mm}
\begin{minipage}{.59\textwidth}
\begin{inaccessibleblock}[Figura: Multiplo di un angolo.]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig044_mult_angolo.pgf}\end{center}
...
congruenti.
 \begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig045_bisettrice.pgf}\end{center}
...
\lstinputlisting[firstline=2]{\folder src/18bisettrice.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
 \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig046_angolo_retto.pgf}\end{center}
\end{figure}
\end{inaccessibleblock}
...
%  \begin{figure}[htb]
\begin{center}
 \input{\folder lbr/fig047_angoli_complementari.pgf}
\end{center}
% \end{figure}
\end{inaccessibleblock}
\end{minipage}
...
%  \begin{figure}[htb]
\begin{center}
 \input{\folder lbr/fig048_angoli_supplementari.pgf}
\end{center}
% \end{figure}
\end{inaccessibleblock}
\end{minipage}
...
%  \begin{figure}[htb]
\begin{center}
 \input{\folder lbr/fig049_angoli_esplementari.pgf}
\end{center}
% \end{figure}
\end{inaccessibleblock}
\end{minipage}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig050_ang_acuto_ottuso.pgf}\end{center}
% \end{figure}
\end{inaccessibleblock}
...
%  \begin{figure}[htb]
\begin{center}
 \input{\folder lbr/fig051_cong_opposti_al_vertice.pgf}
\end{center}
% \end{figure}
\end{inaccessibleblock}
\end{minipage}
...
\lstinputlisting[firstline=2]{\folder src/19angolo60.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig052_perpendicolari.pgf}\end{center}
...
\lstinputlisting[firstline=2]{\folder src/20perpendicolare.py}
\fi

% \begin{procedura}[Perpendicolare 1]\label{proc:fonda_perpendicolare1}
%   Costruzione della perpendicolare a una retta, passante per un punto C 
% appartenente ad essa:
%   \begin{enumerate} [nosep]
%     \item 
%     Traccia la retta passante per due punti qualsiasi A e B, e un punto C 
...
%     \item 
%     Traccia la circonferenza di centro D e raggio ED, quindi la 
% circonferenza 
% di centro E e raggio ED
%     \item 
...
% \end{procedura}
% 
% \begin{procedura}[Perpendicolare 2]\label{proc:fonda_perpendicolare2}
%   Costruzione della perpendicolare a una retta, passante per un punto C 
% esterno 
% ad essa:
%   \begin{enumerate} [nosep]
...
%     \item 
%     Traccia la circonferenza di centro C e raggio CA, che interseca la 
% retta 
% AB 
%     in A ed E. 
%     \item 
...
%     \item 
%     Traccia la retta CF, che è la perpendicolare alla retta AB, passante 
% per 
% C.
%     \end{enumerate}
% \end{procedura}
...
\begin{minipage}{.49\textwidth}
 \begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig053_distanza_P_retta.pgf}\end{center}
...
\begin{minipage}{.49\textwidth}
 \begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig054_asse_segmento.pgf}\end{center}
...
\begin{procedura}[Asse di un segmento]\label{proc:fonda_asse}
...
\lstinputlisting[firstline=2]{\folder src/21asse.py}
\fi
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig061_spezzata.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig062_spezzate.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig063_poligoni.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig064_angoli_poligoni.pgf}\end{center}
...
\begin{minipage}{.49\textwidth}
 \begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig065_angoli_est.pgf}\end{center}
...
\begin{inaccessibleblock}[Figura: TODO]
%  \begin{figure}[htb]
\begin{center}\input{\folder lbr/fig066_corda_diag.pgf}\end{center}
