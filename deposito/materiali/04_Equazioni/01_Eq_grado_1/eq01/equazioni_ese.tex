...
\spazielenx
 ...
 \item applica il primo principio d'equivalenza per lasciare in un membro 
solo 
...
\dotfill;
 \item applica il secondo principio d'equivalenza dividendo ambo i membri per 
il 
...
\spazielenx
 ...
 \item \(x^{3}+6x^{2}+(x+2)^{3}+11x+(x+2)^{2}=(x+3)\left(2x^{2}+7x\right)\) 
  \hfill \(\left[-2\right]\)
 \item \((x+2)^{3}-(x-1)^{3}=9(x+1)^{2}-9x\) \hfill 
\(\left[Indeterminata\right]\)
...
% \begin{esercizio}
% \label{ese:13.25}
% Risolvi le seguenti equazioni nell'insieme~\(\Q\)
% \begin{multicols}{3}
% \begin{enumeratea}
% \spazielenx
%  \item \(3x=\dfrac{1}{3}\)
...
\spazielenx
 ...
 \item \(\dfrac{x-4}{5}\;=\;\dfrac{2x+1}{3}\) \hfill 
...
%   \hfill \(\left[Impossibile\right]\)
 \item 
\(\dfrac{3}{2}x+\dfrac{x}{4}=5\left(\dfrac{2}{3}x-\dfrac{1}{2}\right)-x\)
...
%  \item \((x+1)^{2}=(x-1)^{2}\) \hfill \(\left[\right]\)
 ...
 \item \(\dfrac{(x+1)^{2}}{3}=\dfrac{1}{3}(x^{2}-1)\) \hfill 
\(\left[-1\right]\)
\end{enumeratea}
\end{multicols}
\end{esercizio}
...
\spazielenx
 ...
 \item \(\dfrac{1}{2}(x-2)-\left(\dfrac{x+1}{2}-\dfrac{1+x}{2}\right)=
  ...
  \hfill \(\left[Impossibile\right]\)
 \item 
\(-\left(\dfrac{1}{2}x+3\right)-\dfrac{1}{2}\left(x+\dfrac{5}{2}\right)+
