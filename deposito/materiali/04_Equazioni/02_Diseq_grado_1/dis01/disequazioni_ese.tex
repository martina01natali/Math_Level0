...
\item 
\(\left(-{\dfrac{6}{11}}+2x\right)\cdot\left(-x+\dfrac{9}{2}\right)\le~0\)
...
% 
% \paragraph{\ref{ese:21.46}} a)~\(x\le -3\vee x\ge~3\),\quad b)~\(-16\le 
x\le 
% -1\),\quad
...
\protect\\ 
% b)~\(x<-1\),\quad
% c)~\(-1\le x\le~1\vee x\ge~2\),\quad \protect\\ d)~\(x<-3\vee x>-1\wedge 
x\neq~0\)
% 
...
% 
% \paragraph{\ref{ese:21.52}} a)~\(3\le x<5\),\quad b)~\(x\le -6\vee 
x\ge~3\),\quad
...
% 
% 
\(-{\dfrac{2}{27-3x^{2}}}-\dfrac{x+1}{2x-6}+\dfrac{3-2x}{6x-18}<-{\dfrac{3}{x^
{2}
...
% 
% \paragraph{\ref{ese:21.62}} a)~\(x<0\vee\dfrac{1}{4}\le 
x<\dfrac{1}{2}\),\quad 
...
% b)~\(\left\{x\in \R/0\le x<3\text{ con }x\neq~2\right\}\),\quad
...
% dell'insieme~\(K=\R-\{-1,0,1\}\) \tab\boxV\quad\boxF
% \end{enumeratea}
% \end{esercizio}
...
% essere compreso tra~\(10\unit{cm}\) e~\(20\unit{cm}\), tra quali valori può 
variare 
% il lato
% più piccolo? \hfill 
...
% Se il perimetro del trapezio non deve superare i~\(100\unit{m}\), quali 
valori
