...
\newcommand{\parabolaamidmi}{% Parabola a<0 e Delta<0
  \disegno{
    \assex{-4}{+4}{0}
    \tkzInit[xmin=-4,xmax=+4,ymin=-1.3,ymax=+1.3]
    \tkzFct[domain=-4:+4, ultra thick, color=red!50!black]{-.125*x*x-.5};
    \foreach \x in {-3, 0, +3}
...
\newcommand{\parabolaamadmi}{% Parabola a>0 e Delta<0
  \disegno{
    \assex{-4}{+4}{0}
    \tkzInit[xmin=-4,xmax=+4,ymin=-1.3,ymax=+1.3]
    \tkzFct[domain=-4:+4, ultra thick, color=blue!50!black]{+.125*x*x+.5};
    \foreach \x in {-3, 0, +3}
      \node at (\x, 0) [above, yshift=-3pt] {\(+\)};
  }
}
...
\newcommand{\parabolaamidz}[1]{% Parabola a<0 e Delta=0
  ...
  \disegno{      
    \assex{-4}{+4}{0}
    \tkzInit[xmin=-4,xmax=+4,ymin=-1.3,ymax=+1.3]
    \tkzFct[domain=-4:4, ultra thick, color=red!50!black]{-.125*x*x};
    \draw [black] (0, -.3) -- (0, +.8) node [above] {\(\zero\)};
    \foreach \x in {-3, +3} 
      \node at (\x, 0) [above, yshift=-3pt] {\(-\)};
    \draw (0, .4) circle (3pt);
...
\newcommand{\parabolaamadz}[1]{% Parabola a>0 e Delta=0
  ...
  \disegno{      
    \assex{-4}{+4}{0}
    \tkzInit[xmin=-4,xmax=+4,ymin=-1.3,ymax=+1.3]
    \tkzFct[domain=-4:+4, ultra thick, color=blue!50!black]{+.125*x*x};
    \draw [black] (0, -.3) -- (0, +.8) node [above] {\(\zero\)};
    \foreach \x in {-3, +3} 
      \node at (\x, 0) [above, yshift=-3pt] {\(+\)};
    \draw (0, .4) circle (3pt);
...
\newcommand{\parabolaamidma}[2]{% Parabola a<0 e Delta>0
  ...
  \disegno{
    ...
    \tkzFct[domain=-4:-2, color=red!50!black]{\para};
    \tkzFct[domain=-2:+2, color=blue!50!black]{\para};
    \tkzFct[domain=+2:+4, color=red!50!black]{\para};
    \end{scope}
    \draw [black] (-2, -.3) -- (-2, +.8) node [above] {\(\zeroa\)}
                  (+2, -.3) -- (+2, +.8) node [above] {\(\zerob\)};
    \foreach \x in {-3.2, +3.2} 
      \node at (\x, 0) [above=-1pt, red!50!black] {\(-\)};
      \node at (0, 0) [above=-3pt, blue!50!black] {\(+\)};
    \foreach \x in {-2, +2} {
      \draw[fill=orange] (\x,0) circle (1.5pt);
      \draw (\x, .4) circle (3pt);}
  }
}
...
\newcommand{\parabolaamadma}[2]{% Parabola a>0 e Delta>0
  ...
  \disegno{
    ...
    \tkzInit[xmin=-4,xmax=+4,ymin=-1.3,ymax=+1.3]
    \begin{scope}[ultra thick]
    \tkzFct[domain=-4:-2, color=blue!50!black]{\para};
    \tkzFct[domain=-2:+2, color=red!50!black]{\para};
    \tkzFct[domain=+2:+4, color=blue!50!black]{\para};
    \end{scope}
    \draw [black] (-2, -.3) -- (-2, +.8) node [above] {\(\zeroa\)}
                  (+2, -.3) -- (+2, +.8) node [above] {\(\zerob\)};
    \foreach \x in {-3.2, +3.2} 
      \node at (\x, 0) [above=-3pt, blue!50!black] {\(+\)};
    \node at (0, 0) [above=-1pt, red!50!black] {\(-\)};
    \foreach \x in {-2, +2} {
      \draw[fill=orange] (\x,0) circle (1.5pt);
      \draw (\x, .4) circle (3pt);}
  }
...
%   % \disegno{\inti{0}{-2}{+2}{a}{b}{white}{blue}}
%   \def \posy{#1}
%   \def \posa{#2}
%   \def \posb{#3}
%   \def \labela{#4}
...
%   % \disegno{\inte{0}{5}{-2}{+2}{a}{b}{white}{blue}}
% %   \def \posy{#1}
% %   \def \lung{#2}
% %   \def \posa{#3}
% %   \def \posb{#4}
...
\newcommand{\solprodottoa}{% Soluzione disequazione prodotto di funzioni
  \disegno{
    \assex{-4}{+4}{0}
    \inti{0}{-2.5}{0}{-2}{\frac{3}{2}}{blue}{blue}
    \rayr{0}{4}{2}{+2}{blue}
  }
}
