...
%  \hfill \(\left[x\le \dfrac{5-\sqrt{13}} 2\vee x\ge \dfrac{5+\sqrt{13}} 
% 2\right]\)
...
%  \item~\(x^2+6x-2>0\) \hfill \(\left[x<-3-\sqrt{11}\vee 
% x>-3+\sqrt{11}\right]\)
...
% \paragraph{4.13.} a)~\(x\le -\dfrac 3 2\vee x\ge \dfrac 3 2\),\quad 
% b)~\(0<x<\dfrac 3 
% 2\),\quad c)~ \(\insR\),\quad d)~ \(\insR\),\; e)~ \(x<-1\vee x>2\),\; f)~ 
% \(-6\le x\le 
% -5\)
% 
% \paragraph{4.14.} a)~\(2-\sqrt 7<x<2+\sqrt 7\),\quad b)~\(\emptyset \) 
% ,\quad 
% c)~\(\emptyset \) ,\quad d)~\(x\le -\dfrac 1 3\vee x\ge \dfrac 1 3\),\quad 
% e)~\(-\dfrac 
% 2 3\le x\le \dfrac 1 3\),\quad f)~\(\emptyset \)
% 
% \paragraph{4.15.} a)~\(0\le x\le 4\),\quad b)~ \(-1\le x<-\dfrac 1 
% 9\),\quad 
% c)~\(x<-10\vee x>10\),\quad d)~\(0\le x<\dfrac 6 5\)
% 
% \paragraph{4.16.} a)~\(x<-\dfrac 1 2\vee x>\dfrac 1 2\),\quad b)~
% \(-\dfrac 3 4\le x\le 
% \dfrac 1 3\),\quad c)~\(\insR\),\quad d)~\(\insR-\{\sqrt 2\}\)
...
% \end{esercizio}
% 
% \paragraph{4.27.} a)~\(x<k-1\vee x>k+1\),\, b)~\(a=0\to \emptyset\) 
% \(a>0\to -\dfrac 1 
...
% 4t<x<-2t\),\quad 
% b)~\(s\le 1\to \insR\) \(s>1\to \dfrac{-3}{\sqrt{k-1}}<x<\dfrac 
% 3{\sqrt{k-1}}\)
% 
% \paragraph{4.30.} a)~\(m=0\to \emptyset\) \(m=1\to x<0\) \(0<m<1\to \dfrac 
% m{m-1}<x<0\) 
% \(m<0\to 0<x<\dfrac m{m-1}\) \(m>1\to x<0\vee x>\dfrac m{m-1}\)
...
qualche numero intero nell'\( \IS \)? È vero che l'\( \IS \) è formato 
dall'unione 
...
%  \hfill \(\left[-1<x<\dfrac 1 2\vee x<-2\right]\)
...
% \end{esercizio}
% 
% \paragraph{4.44.} a)~\(x=0\vee -6\le x\le -3\vee x\ge 2\),\quad 
% b)~\(3<x<4\vee 
% x>6\),\quad c)~\(x\ge 1\),\protect\\
% d)~\(-9<x<-6\vee -\dfrac 1 2<x<3\)
% 
...
% \end{esercizio}
% 
% \paragraph{4.46.} a)~\(-\dfrac 1 3<x<0\),\quad b)~\(\IS=\insR\),\quad 
% c)~\(\IS=\emptyset \),\quad d)~\(x<-2\vee -2<x<1\vee x>3\)
% 
% \paragraph{4.47.} a)~\(x<1\vee x>1\),\quad b)~
% \(0<x<\dfrac 1 2\vee x>3\),\quad 
% c)~\(-2<x<0\vee \dfrac 3 4<x<4\),\protect\\
% d)~\(x<-1\vee 4<x<5\vee x>5\)
% 
% \paragraph{4.48.} a)~\(-\dfrac 5 2<x<-1\vee x>8\),\quad b)~\(-7<x<4\),\; 
% c)~\(0<x<\dfrac 8 7\),\; d)~
% \(-2<x<-\dfrac 5 3\vee -\dfrac 3 2<x<\dfrac 4 3\)
% 
% \paragraph{4.49.} a)~
% \(x<-\dfrac 5 2\vee -\dfrac 1 3<x<\dfrac 1 2\vee x>2\),\quad 
% b)~\(x<1\),\quad c)~\(-2<x<2\vee x>\dfrac 7 2\),\quad d)~\(x>6/7\)
% 
...
% \item \(\dfrac{x+3}{4-x}>0\) \hfill \(\left[-3<x<4\right]\)
% \item \(\dfrac{x+5}{x-7}>0\) \hfill \(\left[x<-5\vee x>7\right]\)
...
% \item \(\dfrac{x^2-9}{x^2-5x}>0\) \hfill \(\left[x<-3\vee 0<x<3\vee 
% x>5\right]\)
% \item \(\dfrac{x^2-x-2}{x-x^2+6}>0\) \hfill \(\left[-2<x<-1\vee 
% 2<x<3\right]\)
% \item \(\dfrac{x^2-5x+6}{-3x+7}<0\) \hfill \(\left[2<x<\dfrac 7 3 \vee 
% x>3\right]\)
% \item \(\dfrac{2x+8}{x^2+4x-12}>0\) \hfill \(\left[-6<x<-4\vee x>2\right]\)
\end{enumeratea}
\end{multicols}
\end{esercizio}
...
Determinare l'Insieme Soluzione delle seguenti disequazioni fratte.
\begin{enumeratea}
% \item \(\dfrac{x^2-2x-63}{4x+5-x^2}>0\) \hfill \(\left[-7<x<-1\vee 
% 5<x<9\right]\)
% \item \(\dfrac{4-x^2+3x}{x^2-x}>0\) \hfill \(\left[-1<x<0\vee 1<x<4\right]\)
% \item \(\dfrac{x^2-2x}{5-x^2}>0\) 
%  \hfill \(\left[-\sqrt 5<x<0\vee 2<x<\sqrt 5\right]\)
\item \(\dfrac{x^2-x-2}{-3x^2+3x+18}\le 0\) 
...
\item \(\dfrac{4x+7}{3x^2-x-2}>0\) 
 \hfill \(\left[-\dfrac 7 4<x<-\dfrac 2 3\vee x>1\right]\)
...
\item \(\dfrac{2x-4x^2}{x^2+x-12}\cdot \dfrac{16-x^2}{5x-x^2}\le 0\) 
 \hfill \(\left[x\le \dfrac 1 2\vee 3<x\le 4\vee x>5 \wedge 
 x\neq 0 \wedge x\neq -4\right]\)
\item \(\dfrac{1-x^2}{x^2}\le \dfrac 1{x^2}-x^2-\dfrac 1 2\) 
 \hfill \(\left[-\dfrac{\sqrt 2} 2\le x\le \dfrac{\sqrt 2} 2 \wedge 
 x\neq 0\right]\)
\item \(\dfrac{x+2}{x-1}\ge \dfrac{24}{x+1}-\dfrac x{x^2-1}\) 
 \hfill \(\left[x<-1\vee 1<x\le 10-\sqrt{74}\vee x\ge 10+\sqrt{74}\right]\)
\item \(\dfrac 1 x+\dfrac 1{x-1}+\dfrac 1{x+1}<\dfrac{2x+1}{x^2-1}\) 
 \hfill \(\left[-\dfrac{\sqrt 2} 2\le x\le \dfrac{\sqrt 2} 2\right]\)
\item \(\dfrac x{x+2}\ge \dfrac{x-4}{x^2-4}\) 
 \hfill \(\left[x<-2\vee x>2\right]\)
\item \(\dfrac{4x+1}{x^2-9}+\dfrac{1-x}{x+3}<6-\dfrac x{x-3}\) 
 \hfill \(\left[x<-3\vee -\dfrac{13} 6<x<3\vee x>4\right]\)
\item \(\dfrac{x+1}{2x-1}+\dfrac 3{4x+10}\ge 1-\dfrac{2x+2}{4x^2+8x-5}\) 
 \hfill \(\left[-\dfrac 5 2<x\le -\dfrac 3 2\vee \dfrac 1 2<x\le \dfrac 7 
2\right]\)
...
\item \(\left\{\begin{array}{l}4x-x^2-3<0\\3x\ge 2\end{array}\right.\)
 \hfill \(\left[\dfrac 2 3\le x<1\vee x>3\right]\)
...
\item \(\left\{\begin{array}{l}x^4-8\ge 1\\\dfrac{5-x} x<\dfrac 1 2\\x^3-1<0
              \end{array}\right.\)
...
% \begin{esercizio}[\Ast]
% \label{ese:4.82}
% Dato il sistema \(\left\{\begin{array}{l}{x(x-3)>3\left(\dfrac{x^2} 
% 2-2x\right)}\\{2+x\cdot \dfrac{3x-7} 3\ge 5-\dfrac 1 
% 3x}\end{array}\right.\) 
% determina i numeri naturali che lo risolvono. 
% \hfill \(\left[3, 4, 5\right]\)
% \end{esercizio}
